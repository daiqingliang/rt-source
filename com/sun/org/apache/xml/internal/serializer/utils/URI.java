...
final class URI {
  ...
  private void initialize(URI paramURI, String paramString) throws MalformedURIException {
    ...
    if (k < 0) {
      if (paramURI == null)
        throw new MalformedURIException(Utils.messages.createMessage("ER_NO_SCHEME_IN_URI", new Object[] { str })); 
    } else {
  ...
  public int hashCode() {
    null = 5;
    null = 41 * null + Objects.hashCode(this.m_scheme);
    null = 41 * null + Objects.hashCode(this.m_userinfo);
    null = 41 * null + Objects.hashCode(this.m_host);
    null = 41 * null + this.m_port;
    null = 41 * null + Objects.hashCode(this.m_path);
    null = 41 * null + Objects.hashCode(this.m_queryString);
    return 41 * null + Objects.hashCode(this.m_fragment);
  }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\org\apache\xml\internal\serialize\\utils\URI.class
