...
public final class ErrorMsg {
  ...
  public Throwable getCause() { return this._cause; }
  
  private String getFileName(SyntaxTreeNode paramSyntaxTreeNode) {
    Stylesheet stylesheet = paramSyntaxTreeNode.getStylesheet();
  ...
  public String toString() {
    String str = (this._params == null) ? ((null != this._code) ? getErrorMessage() : this._message) : MessageFormat.format(getErrorMessage(), this._params);
  ...
  private String getErrorMessage() { return _bundle.getString(this._code); }
  
  public void setWarningError(boolean paramBoolean) { this._isWarningError = paramBoolean; }
  
  public boolean isWarningError() { return this._isWarningError; }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\org\apache\xalan\internal\xsltc\compile\\util\ErrorMsg.class
