...
public class XSLTErrorResources_ja extends ListResourceBundle {
  ...
  public Object[][] getContents() { return new Object[][] { 
        { "ER0000", "{0}" }, { "ER_NO_CURLYBRACE", "エラー: 式内に'{'を持つことはできません" }, { "ER_ILLEGAL_ATTRIBUTE", "{0}に不正な属性があります: {1}" }, { "ER_NULL_SOURCENODE_APPLYIMPORTS", "sourceNodeはxsl:apply-imports内でnullです。" }, { "ER_CANNOT_ADD", "{0}を{1}に追加できません" }, { "ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES", "sourceNodeはhandleApplyTemplatesInstruction内でnullです。" }, { "ER_NO_NAME_ATTRIB", "{0}にはname属性が必要です。" }, { "ER_TEMPLATE_NOT_FOUND", "名前{0}のテンプレートが見つかりませんでした" }, { "ER_CANT_RESOLVE_NAME_AVT", "xsl:call-templateの名前AVTを解決できませんでした。" }, { "ER_REQUIRES_ATTRIB", "{0}は属性{1}が必要です" }, 
        { "ER_MUST_HAVE_TEST_ATTRIB", "{0}は''test''属性を持つ必要があります。" }, { "ER_BAD_VAL_ON_LEVEL_ATTRIB", "level属性の値が不正です: {0}" }, { "ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML", "processing-instruction名は'xml'にできません" }, { "ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME", "processing-instruction名は有効なNCNameである必要があります: {0}" }, { "ER_NEED_MATCH_ATTRIB", "モードがある場合、{0}にはmatch属性が必要です。" }, { "ER_NEED_NAME_OR_MATCH_ATTRIB", "{0}にはnameまたはmatch属性が必要です。" }, { "ER_CANT_RESOLVE_NSPREFIX", "ネームスペースの接頭辞を解決できません: {0}" }, { "ER_ILLEGAL_VALUE", "xml:spaceの値が不正です: {0}" }, { "ER_NO_OWNERDOC", "子ノードに所有者ドキュメントがありません。" }, { "ER_ELEMTEMPLATEELEM_ERR", "ElemTemplateElementエラー: {0}" }, 
        { "ER_NULL_CHILD", "nullの子を追加しようとしました。" }, { "ER_NEED_SELECT_ATTRIB", "{0}にはselect属性が必要です。" }, { "ER_NEED_TEST_ATTRIB", "xsl:whenには'test'属性が必要です。" }, { "ER_NEED_NAME_ATTRIB", "xsl:with-paramには'name'属性が必要です。" }, { "ER_NO_CONTEXT_OWNERDOC", "コンテキストに所有者ドキュメントがありません。" }, { "ER_COULD_NOT_CREATE_XML_PROC_LIAISON", "XML TransformerFactory Liaisonを作成できませんでした: {0}" }, { "ER_PROCESS_NOT_SUCCESSFUL", "Xalan: プロセスは成功しませんでした。" }, { "ER_NOT_SUCCESSFUL", "Xalan: は成功しませんでした。" }, { "ER_ENCODING_NOT_SUPPORTED", "エンコーディング{0}はサポートされていません" }, { "ER_COULD_NOT_CREATE_TRACELISTENER", "TraceListenerを作成できませんでした: {0}" }, 
        { "ER_KEY_REQUIRES_NAME_ATTRIB", "xsl:keyには'name'属性が必要です。" }, { "ER_KEY_REQUIRES_MATCH_ATTRIB", "xsl:keyには'match'属性が必要です。" }, { "ER_KEY_REQUIRES_USE_ATTRIB", "xsl:keyには'use'属性が必要です。" }, { "ER_REQUIRES_ELEMENTS_ATTRIB", "(StylesheetHandler) {0}には''elements''属性が必要です。" }, { "ER_MISSING_PREFIX_ATTRIB", "(StylesheetHandler) {0}属性''prefix''がありません" }, { "ER_BAD_STYLESHEET_URL", "スタイルシートURLが不正です: {0}" }, { "ER_FILE_NOT_FOUND", "スタイルシート・ファイルが見つかりませんでした: {0}" }, { "ER_IOEXCEPTION", "スタイルシート・ファイルに入出力例外があります: {0}" }, { "ER_NO_HREF_ATTRIB", "(StylesheetHandler) {0}のhref属性が見つかりませんでした" }, { "ER_STYLESHEET_INCLUDES_ITSELF", "(StylesheetHandler) {0}はそれ自体を直接的または間接的に含んでいます。" }, 
        { "ER_PROCESSINCLUDE_ERROR", "StylesheetHandler.processIncludeエラー、{0}" }, { "ER_MISSING_LANG_ATTRIB", "(StylesheetHandler) {0}属性''lang''がありません" }, { "ER_MISSING_CONTAINER_ELEMENT_COMPONENT", "(StylesheetHandler) {0}要素の配置が不正です。コンテナ要素''component''がありません" }, { "ER_CAN_ONLY_OUTPUT_TO_ELEMENT", "Element、DocumentFragment、DocumentまたはPrintWriterにのみ出力できます。" }, { "ER_PROCESS_ERROR", "StylesheetRoot.processエラー" }, { "ER_UNIMPLNODE_ERROR", "UnImplNodeエラー: {0}" }, { "ER_NO_SELECT_EXPRESSION", "エラー。xpath選択式(-select)が見つかりませんでした。" }, { "ER_CANNOT_SERIALIZE_XSLPROCESSOR", "XSLProcessorをシリアライズできません。" }, { "ER_NO_INPUT_STYLESHEET", "スタイルシート入力が指定されませんでした。" }, { "ER_FAILED_PROCESS_STYLESHEET", "スタイルシートの処理に失敗しました。" }, 
        { "ER_COULDNT_PARSE_DOC", "{0}ドキュメントを解析できませんでした。" }, { "ER_COULDNT_FIND_FRAGMENT", "フラグメントが見つかりませんでした: {0}" }, { "ER_NODE_NOT_ELEMENT", "フラグメント識別子によって指示されたノードは要素ではありませんでした: {0}" }, { "ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB", "for-eachはmatchまたはname属性を持つ必要があります" }, { "ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB", "テンプレートはmatchまたはname属性を持つ必要があります" }, { "ER_NO_CLONE_OF_DOCUMENT_FRAG", "ドキュメント・フラグメントのクローンを作成できません。" }, { "ER_CANT_CREATE_ITEM", "結果ツリーに項目を作成できません: {0}" }, { "ER_XMLSPACE_ILLEGAL_VALUE", "ソースXMLのxml:spaceの値が不正です: {0}" }, { "ER_NO_XSLKEY_DECLARATION", "{0}のxsl:key宣言がありません。" }, { "ER_CANT_CREATE_URL", "エラー。{0}のURLを作成できません" }, 
        { "ER_XSLFUNCTIONS_UNSUPPORTED", "xsl:functionsはサポートされていません" }, { "ER_PROCESSOR_ERROR", "XSLT TransformerFactoryエラー" }, { "ER_NOT_ALLOWED_INSIDE_STYLESHEET", "(StylesheetHandler) {0}はスタイルシート内で許可されません。" }, { "ER_RESULTNS_NOT_SUPPORTED", "result-nsは現在はサポートされていません。かわりにxsl:outputを使用してください。" }, { "ER_DEFAULTSPACE_NOT_SUPPORTED", "default-spaceは現在はサポートされていません。かわりにxsl:strip-spaceまたはxsl:preserve-spaceを使用してください。" }, { "ER_INDENTRESULT_NOT_SUPPORTED", "indent-resultは現在はサポートされていません。かわりにxsl:outputを使用してください。" }, { "ER_ILLEGAL_ATTRIB", "(StylesheetHandler) {0}には不正な属性があります: {1}" }, { "ER_UNKNOWN_XSL_ELEM", "不明なXSL要素: {0}" }, { "ER_BAD_XSLSORT_USE", "(StylesheetHandler) xsl:sortは、xsl:apply-templatesまたはxsl:for-eachとともにのみ使用できます。" }, { "ER_MISPLACED_XSLWHEN", "(StylesheetHandler) xsl:whenの配置が不正です。" }, 
        { "ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:whenの親がxsl:chooseではありません。" }, { "ER_MISPLACED_XSLOTHERWISE", "(StylesheetHandler) xsl:otherwiseの配置が不正です。" }, { "ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:otherwiseの親がxsl:chooseではありません。" }, { "ER_NOT_ALLOWED_INSIDE_TEMPLATE", "(StylesheetHandler) {0}はテンプレート内で許可されません。" }, { "ER_UNKNOWN_EXT_NS_PREFIX", "(StylesheetHandler) 不明な{0}拡張ネームスペースの接頭辞{1}です" }, { "ER_IMPORTS_AS_FIRST_ELEM", "(StylesheetHandler) インポートはスタイルシートの最初の要素としてのみ使用できます。" }, { "ER_IMPORTING_ITSELF", "(StylesheetHandler) {0}はそれ自体を直接または間接的にインポートしています。" }, { "ER_XMLSPACE_ILLEGAL_VAL", "(StylesheetHandler) xml:spaceの値が不正です: {0}" }, { "ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL", "processStylesheetは失敗しました。" }, { "ER_SAX_EXCEPTION", "SAX例外" }, 
        { "ER_FUNCTION_NOT_SUPPORTED", "関数がサポートされていません。" }, { "ER_XSLT_ERROR", "XSLTエラー" }, { "ER_CURRENCY_SIGN_ILLEGAL", "通貨記号はフォーマット・パターン文字列内で許可されません" }, { "ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM", "ドキュメント関数はスタイルシートDOMでサポートされていません。" }, { "ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER", "非接頭辞リゾルバの接頭辞を解決できません。" }, { "ER_REDIRECT_COULDNT_GET_FILENAME", "リダイレクト拡張: ファイル名を取得できませんでした - fileまたはselect属性が有効な文字列を返す必要があります。" }, { "ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT", "リダイレクト拡張でFormatterListenerを作成できません。" }, { "ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX", "exclude-result-prefixesの接頭辞が無効です: {0}" }, { "ER_MISSING_NS_URI", "指定した接頭辞のネームスペースURIがありません" }, { "ER_MISSING_ARG_FOR_OPTION", "オプション{0}の引数がありません" }, 
        { "ER_INVALID_OPTION", "無効なオプション: {0}" }, { "ER_MALFORMED_FORMAT_STRING", "不正なフォーマットの文字列です: {0}" }, { "ER_STYLESHEET_REQUIRES_VERSION_ATTRIB", "xsl:stylesheetは'version'属性が必要です。" }, { "ER_ILLEGAL_ATTRIBUTE_VALUE", "属性{0}の値が不正です: {1}" }, { "ER_CHOOSE_REQUIRES_WHEN", "xsl:chooseはxsl:whenが必要です" }, { "ER_NO_APPLY_IMPORT_IN_FOR_EACH", "xsl:apply-importsはxsl:for-each内で許可されません" }, { "ER_CANT_USE_DTM_FOR_OUTPUT", "出力DOMノードにDTMLiaisonを使用できません...かわりにcom.sun.org.apache.xpath.internal.DOM2Helperを渡してください。" }, { "ER_CANT_USE_DTM_FOR_INPUT", "入力DOMノードにDTMLiaisonを使用できません...かわりにcom.sun.org.apache.xpath.internal.DOM2Helperを渡してください。" }, { "ER_CALL_TO_EXT_FAILED", "拡張要素の呼出しが失敗しました: {0}" }, { "ER_PREFIX_MUST_RESOLVE", "接頭辞はネームスペースに解決される必要があります: {0}" }, 
        { "ER_INVALID_UTF16_SURROGATE", "無効なUTF-16サロゲートが検出されました: {0}。" }, { "ER_XSLATTRSET_USED_ITSELF", "xsl:attribute-set {0}がそれ自体を使用し、無限ループが発生します。" }, { "ER_CANNOT_MIX_XERCESDOM", "非Xerces-DOM入力とXerces-DOM出力を同時に使用することはできません。" }, { "ER_TOO_MANY_LISTENERS", "addTraceListenersToStylesheet - TooManyListenersException" }, { "ER_IN_ELEMTEMPLATEELEM_READOBJECT", "ElemTemplateElement.readObject内: {0}" }, { "ER_DUPLICATE_NAMED_TEMPLATE", "名前{0}のテンプレートが複数見つかりました" }, { "ER_INVALID_KEY_CALL", "無効な関数呼出し: 再帰的なkey()の呼出しは許可されません" }, { "ER_REFERENCING_ITSELF", "変数{0}はそれ自体を直接または間接的に参照しています。" }, { "ER_ILLEGAL_DOMSOURCE_INPUT", "newTemplatesのDOMSourceについて入力ノードをnullにすることはできません。" }, { "ER_CLASS_NOT_FOUND_FOR_OPTION", "オプション{0}についてクラス・ファイルが見つかりません" }, 
        { "ER_REQUIRED_ELEM_NOT_FOUND", "必須要素が見つかりません: {0}" }, { "ER_INPUT_CANNOT_BE_NULL", "InputStreamをnullにすることはできません" }, { "ER_URI_CANNOT_BE_NULL", "URIをnullにすることはできません" }, { "ER_FILE_CANNOT_BE_NULL", "ファイルをnullにすることはできません" }, { "ER_SOURCE_CANNOT_BE_NULL", "InputSourceをnullにすることはできません" }, { "ER_CANNOT_INIT_BSFMGR", "BSFマネージャを初期化できませんでした" }, { "ER_CANNOT_CMPL_EXTENSN", "拡張をコンパイルできませんでした" }, { "ER_CANNOT_CREATE_EXTENSN", "{1}が原因で拡張{0}を作成できませんでした" }, { "ER_INSTANCE_MTHD_CALL_REQUIRES", "メソッド{0}のインスタンス・メソッド呼出しでは、最初の引数としてオブジェクト・インスタンスが必要です" }, { "ER_INVALID_ELEMENT_NAME", "無効な要素名が指定されました{0}" }, 
        { "ER_ELEMENT_NAME_METHOD_STATIC", "要素名メソッドはstatic {0}である必要があります" }, { "ER_EXTENSION_FUNC_UNKNOWN", "拡張関数{0} : {1}が不明です" }, { "ER_MORE_MATCH_CONSTRUCTOR", "{0}のコンストラクタに複数の最適一致があります" }, { "ER_MORE_MATCH_METHOD", "メソッド{0}に複数の最適一致があります" }, { "ER_MORE_MATCH_ELEMENT", "要素メソッド{0}に複数の最適一致があります" }, { "ER_INVALID_CONTEXT_PASSED", "{0}を評価するために無効なコンテキストが渡されました" }, { "ER_POOL_EXISTS", "プールはすでに存在します" }, { "ER_NO_DRIVER_NAME", "ドライバ名が指定されていません" }, { "ER_NO_URL", "URLが指定されていません" }, { "ER_POOL_SIZE_LESSTHAN_ONE", "プール・サイズが1より小さいです。" }, 
        { "ER_INVALID_DRIVER", "無効なドライバ名が指定されました。" }, { "ER_NO_STYLESHEETROOT", "スタイルシート・ルートが見つかりませんでした。" }, { "ER_ILLEGAL_XMLSPACE_VALUE", "xml:spaceの値が不正です" }, { "ER_PROCESSFROMNODE_FAILED", "processFromNodeが失敗しました" }, { "ER_RESOURCE_COULD_NOT_LOAD", "リソース[ {0} ]をロードできませんでした: {1} \n {2} \t {3}" }, { "ER_BUFFER_SIZE_LESSTHAN_ZERO", "バッファ・サイズ<=0" }, { "ER_UNKNOWN_ERROR_CALLING_EXTENSION", "拡張を呼び出すときに不明なエラーが発生しました" }, { "ER_NO_NAMESPACE_DECL", "接頭辞{0}には、対応するネームスペース宣言がありません" }, { "ER_ELEM_CONTENT_NOT_ALLOWED", "要素の内容はlang=javaclass {0}について許可されません" }, { "ER_STYLESHEET_DIRECTED_TERMINATION", "スタイルシートにより終了が指示されました" }, 
        { "ER_ONE_OR_TWO", "1または2" }, { "ER_TWO_OR_THREE", "2または3" }, { "ER_COULD_NOT_LOAD_RESOURCE", "{0}をロードできませんでした(CLASSPATHを確認してください)。現在は単にデフォルトを使用しています" }, { "ER_CANNOT_INIT_DEFAULT_TEMPLATES", "デフォルト・テンプレートを初期化できません" }, { "ER_RESULT_NULL", "結果はnullにできません" }, { "ER_RESULT_COULD_NOT_BE_SET", "結果を設定できませんでした" }, { "ER_NO_OUTPUT_SPECIFIED", "出力が指定されていません" }, { "ER_CANNOT_TRANSFORM_TO_RESULT_TYPE", "タイプ{0}の結果に変換できません" }, { "ER_CANNOT_TRANSFORM_SOURCE_TYPE", "タイプ{0}のソースに変換できません" }, { "ER_NULL_CONTENT_HANDLER", "Nullのコンテンツ・ハンドラ" }, 
        { "ER_NULL_ERROR_HANDLER", "Nullのエラー・ハンドラ" }, { "ER_CANNOT_CALL_PARSE", "ContentHandlerが設定されていない場合、解析を呼び出すことができません" }, { "ER_NO_PARENT_FOR_FILTER", "フィルタの親がありません" }, { "ER_NO_STYLESHEET_IN_MEDIA", "スタイルシートが{0}にありません。メディア= {1}" }, { "ER_NO_STYLESHEET_PI", "xml-stylesheet PIが{0}に見つかりません" }, { "ER_NOT_SUPPORTED", "サポートされていません: {0}" }, { "ER_PROPERTY_VALUE_BOOLEAN", "プロパティ{0}の値はBooleanインスタンスである必要があります" }, { "ER_COULD_NOT_FIND_EXTERN_SCRIPT", "{0}の外部スクリプトに到達できませんでした" }, { "ER_RESOURCE_COULD_NOT_FIND", "リソース[ {0} ]は見つかりませんでした。\n {1}" }, { "ER_OUTPUT_PROPERTY_NOT_RECOGNIZED", "出力プロパティが認識されません: {0}" }, 
        { "ER_FAILED_CREATING_ELEMLITRSLT", "ElemLiteralResultインスタンスの作成に失敗しました" }, { "ER_VALUE_SHOULD_BE_NUMBER", "{0}の値には解析可能な数値が含まれる必要があります" }, { "ER_VALUE_SHOULD_EQUAL", "{0}の値はyesまたはnoに等しい必要があります" }, { "ER_FAILED_CALLING_METHOD", "{0}メソッドの呼出しに失敗しました" }, { "ER_FAILED_CREATING_ELEMTMPL", "ElemTemplateElementインスタンスの作成に失敗しました" }, { "ER_CHARS_NOT_ALLOWED", "文字はドキュメントのこのポイントでは許可されません" }, { "ER_ATTR_NOT_ALLOWED", "\"{0}\"属性は{1}要素では許可されません。" }, { "ER_BAD_VALUE", "{0}の不正な値{1} " }, { "ER_ATTRIB_VALUE_NOT_FOUND", "{0}属性値が見つかりません " }, { "ER_ATTRIB_VALUE_NOT_RECOGNIZED", "{0}属性値が認識されません " }, 
        { "ER_NULL_URI_NAMESPACE", "nullのURIを持つネームスペースの接頭辞を生成しようとしました" }, { "ER_NUMBER_TOO_BIG", "最大のLong整数よりも大きい数値をフォーマットしようとしました" }, { "ER_CANNOT_FIND_SAX1_DRIVER", "SAX1ドライバ・クラス{0}が見つかりません" }, { "ER_SAX1_DRIVER_NOT_LOADED", "SAX1ドライバ・クラス{0}が見つかりましたがロードできません" }, { "ER_SAX1_DRIVER_NOT_INSTANTIATED", "SAX1ドライバ・クラス{0}がロードされましたがインスタンス化できません" }, { "ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER", "SAX1ドライバ・クラス{0}はorg.xml.sax.Parserを実装できません" }, { "ER_PARSER_PROPERTY_NOT_SPECIFIED", "システム・プロパティorg.xml.sax.parserが指定されていません" }, { "ER_PARSER_ARG_CANNOT_BE_NULL", "パーサー引数はnullでない必要があります" }, { "ER_FEATURE", "機能: {0}" }, { "ER_PROPERTY", "プロパティ: {0}" }, 
        { "ER_NULL_ENTITY_RESOLVER", "Nullエンティティ・リゾルバ" }, { "ER_NULL_DTD_HANDLER", "Null DTDハンドラ" }, { "ER_NO_DRIVER_NAME_SPECIFIED", "ドライバ名が指定されていません。" }, { "ER_NO_URL_SPECIFIED", "URLが指定されていません。" }, { "ER_POOLSIZE_LESS_THAN_ONE", "プール・サイズが1より小さいです。" }, { "ER_INVALID_DRIVER_NAME", "無効なドライバ名が指定されました。" }, { "ER_ERRORLISTENER", "ErrorListener" }, { "ER_ASSERT_NO_TEMPLATE_PARENT", "プログラマのエラー。式にElemTemplateElementの親がありません。" }, { "ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR", "RedundentExprEliminatorでのプログラマのアサーション: {0}" }, { "ER_NOT_ALLOWED_IN_POSITION", "{0}はスタイルシートのこの位置では許可されません。" }, 
        { "ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION", "空白以外のテキストはスタイルシートのこの位置では許可されません。" }, { "INVALID_TCHAR", "不正な値: {1}がCHAR属性{0}に使用されました。CHAR型の属性は1文字のみである必要があります。" }, { "INVALID_QNAME", "不正な値: {1}がQNAME属性{0}に使用されました" }, { "INVALID_ENUM", "不正な値: {1}がENUM属性{0}に使用されました。有効な値は{2}です。" }, { "INVALID_NMTOKEN", "不正な値: {1}がNMTOKEN属性{0}に使用されました " }, { "INVALID_NCNAME", "不正な値: {1}がNCNAME属性{0}に使用されました " }, { "INVALID_BOOLEAN", "不正な値: {1}がboolean属性{0}に使用されました " }, { "INVALID_NUMBER", "不正な値: {1}が数値属性{0}に使用されました " }, { "ER_ARG_LITERAL", "一致パターンにおける{0}の引数はリテラルである必要があります。" }, { "ER_DUPLICATE_GLOBAL_VAR", "グローバル変数宣言が重複しています。" }, 
        { "ER_DUPLICATE_VAR", "変数宣言が重複しています。" }, { "ER_TEMPLATE_NAME_MATCH", "xsl:templateにはname属性またはmatch属性(あるいは両方)が必要です" }, { "ER_INVALID_PREFIX", "exclude-result-prefixesの接頭辞が無効です: {0}" }, { "ER_NO_ATTRIB_SET", "{0}という名前のattribute-setは存在しません" }, { "ER_FUNCTION_NOT_FOUND", "{0}という名前の機能は存在しません" }, { "ER_CANT_HAVE_CONTENT_AND_SELECT", "{0}要素にはコンテンツとselect属性の両方を含めないでください。" }, { "ER_INVALID_SET_PARAM_VALUE", "パラメータ{0}は有効なJavaオブジェクトである必要があります" }, { "ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT", "xsl:namespace-alias要素のresult-prefix属性に値'#default'がありますが、要素のスコープ内にデフォルトのネームスペースの宣言がありません" }, { "ER_INVALID_SET_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX", "xsl:namespace-alias要素のresult-prefix属性に値''{0}''がありますが、要素のスコープ内に接頭辞''{0}''のネームスペース宣言がありません。" }, { "ER_SET_FEATURE_NULL_NAME", "機能名はTransformerFactory.setFeature(String name, boolean value)内でnullにできません。" }, 
        ...
        { "WG_NO_LOCALE_IN_FORMATNUMBER", "Xalanはformat-number関数内のロケール名をまだ処理できません。" }, { "WG_LOCALE_NOT_FOUND", "警告: xml:lang={0}のロケールが見つかりませんでした" }, { "WG_CANNOT_MAKE_URL_FROM", "{0}からURLを作成できません" }, { "WG_CANNOT_LOAD_REQUESTED_DOC", "リクエストされたドキュメント{0}をロードできません" }, { "WG_CANNOT_FIND_COLLATOR", "<sort xml:lang={0}のコレータが見つかりませんでした" }, { "WG_FUNCTIONS_SHOULD_USE_URL", "古い構文: 関数命令は{0}のURLを使用する必要があります" }, { "WG_ENCODING_NOT_SUPPORTED_USING_UTF8", "エンコーディング{0}はサポートされていません。UTF-8を使用します" }, { "WG_ENCODING_NOT_SUPPORTED_USING_JAVA", "エンコーディング{0}はサポートされていません。Java {1}を使用します" }, { "WG_SPECIFICITY_CONFLICTS", "特異性の競合が見つかりました: {0}。スタイルシート内で最後に見つかったものが使用されます。" }, { "WG_PARSING_AND_PREPARING", "========= {0}の解析および準備中 ==========" }, 
        { "WG_ATTR_TEMPLATE", "属性テンプレート、{0}" }, { "WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESP", "xsl:strip-spaceとxsl:preserve-spaceの間で一致が競合しています" }, { "WG_ATTRIB_NOT_HANDLED", "Xalanは{0}属性をまだ処理しません。" }, { "WG_NO_DECIMALFORMAT_DECLARATION", "10進数フォーマット{0}の宣言が見つかりません" }, { "WG_OLD_XSLT_NS", "XSLTのネームスペースがないか不正です。 " }, { "WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED", "デフォルトのxsl:decimal-format宣言は1つのみ許可されます。" }, { "WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE", "xsl:decimal-format名は固有である必要があります。名前\"{0}\"は重複しています。" }, { "WG_ILLEGAL_ATTRIBUTE", "{0}に不正な属性があります: {1}" }, { "WG_COULD_NOT_RESOLVE_PREFIX", "ネームスペースの接頭辞{0}を解決できませんでした。ノードは無視されます。" }, { "WG_STYLESHEET_REQUIRES_VERSION_ATTRIB", "xsl:stylesheetは'version'属性が必要です。" }, 
        { "WG_ILLEGAL_ATTRIBUTE_NAME", "不正な属性名: {0}" }, { "WG_ILLEGAL_ATTRIBUTE_VALUE", "無効な値が属性{0}に使用されました: {1}" }, { "WG_EMPTY_SECOND_ARG", "ドキュメント関数の2番目の引数からの結果ノードセットが空です。空のノードセットを返します。" }, { "WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML", "xsl:processing-instruction名の'name'属性の値は'xml'でない必要があります" }, { "WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME", "xsl:processing-instructionの''name''属性の値は有効なNCNameである必要があります: {0}" }, { "WG_ILLEGAL_ATTRIBUTE_POSITION", "子ノードの後または要素が生成される前に属性{0}を追加できません。属性は無視されます。" }, { "NO_MODIFICATION_ALLOWED_ERR", "変更が許可されていないオブジェクトを変更しようとしました。" }, { "ui_language", "ja" }, { "help_language", "ja" }, { "language", "ja" }, 
        { "BAD_CODE", "createMessageのパラメータが範囲外です" }, { "FORMAT_FAILED", "messageFormatの呼出し中に例外がスローされました" }, { "version", ">>>>>>> Xalanバージョン " }, { "version2", "<<<<<<<" }, { "yes", "yes" }, { "line", "行番号" }, { "column", "列番号" }, { "xsldone", "XSLProcessor: 完了しました" }, { "xslProc_option", "Xalan-Jコマンド行プロセス・クラスのオプション:" }, { "xslProc_option", "Xalan-Jコマンド行プロセス・クラスのオプション:" }, 
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\org\apache\xalan\internal\res\XSLTErrorResources_ja.class
