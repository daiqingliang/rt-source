...
public class XSLTErrorResources_zh_CN extends ListResourceBundle {
  ...
  public Object[][] getContents() { return new Object[][] { 
        { "ER0000", "{0}" }, { "ER_NO_CURLYBRACE", "错误: 表达式中不能包含 '{'" }, { "ER_ILLEGAL_ATTRIBUTE", "{0}具有非法属性: {1}" }, { "ER_NULL_SOURCENODE_APPLYIMPORTS", "sourceNode 在 xsl:apply-imports 中为空值!" }, { "ER_CANNOT_ADD", "无法向{1}添加{0}" }, { "ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES", "sourceNode 在 handleApplyTemplatesInstruction 中为空值!" }, { "ER_NO_NAME_ATTRIB", "{0}必须具有 name 属性。" }, { "ER_TEMPLATE_NOT_FOUND", "找不到名为{0}的模板" }, { "ER_CANT_RESOLVE_NAME_AVT", "无法解析 xsl:call-template 中的名称 AVT。" }, { "ER_REQUIRES_ATTRIB", "{0}需要属性: {1}" }, 
        { "ER_MUST_HAVE_TEST_ATTRIB", "{0}必须具有 ''test'' 属性。" }, { "ER_BAD_VAL_ON_LEVEL_ATTRIB", "level 属性的值错误: {0}" }, { "ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML", "processing-instruction 名称不能为 'xml'" }, { "ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME", "processing-instruction 名称必须是有效的 NCName: {0}" }, { "ER_NEED_MATCH_ATTRIB", "如果{0}具有某种模式, 则必须具有 match 属性。" }, { "ER_NEED_NAME_OR_MATCH_ATTRIB", "{0}需要 name 或 match 属性。" }, { "ER_CANT_RESOLVE_NSPREFIX", "无法解析名称空间前缀: {0}" }, { "ER_ILLEGAL_VALUE", "xml:space 具有非法值: {0}" }, { "ER_NO_OWNERDOC", "子节点没有所有者文档!" }, { "ER_ELEMTEMPLATEELEM_ERR", "ElemTemplateElement 错误: {0}" }, 
        { "ER_NULL_CHILD", "正在尝试添加空子级!" }, { "ER_NEED_SELECT_ATTRIB", "{0}需要 select 属性。" }, { "ER_NEED_TEST_ATTRIB", "xsl:when 必须具有 'test' 属性。" }, { "ER_NEED_NAME_ATTRIB", "xsl:with-param 必须具有 'name' 属性。" }, { "ER_NO_CONTEXT_OWNERDOC", "上下文没有所有者文档!" }, { "ER_COULD_NOT_CREATE_XML_PROC_LIAISON", "无法创建 XML TransformerFactory Liaison: {0}" }, { "ER_PROCESS_NOT_SUCCESSFUL", "Xalan: 进程未成功。" }, { "ER_NOT_SUCCESSFUL", "Xalan: 未成功。" }, { "ER_ENCODING_NOT_SUPPORTED", "不支持编码: {0}" }, { "ER_COULD_NOT_CREATE_TRACELISTENER", "无法创建 TraceListener: {0}" }, 
        { "ER_KEY_REQUIRES_NAME_ATTRIB", "xsl:key 需要 'name' 属性!" }, { "ER_KEY_REQUIRES_MATCH_ATTRIB", "xsl:key 需要 'match' 属性!" }, { "ER_KEY_REQUIRES_USE_ATTRIB", "xsl:key 需要 'use' 属性!" }, { "ER_REQUIRES_ELEMENTS_ATTRIB", "(StylesheetHandler) {0}需要 ''elements'' 属性!" }, { "ER_MISSING_PREFIX_ATTRIB", "(StylesheetHandler) 缺少{0}属性 ''prefix''" }, { "ER_BAD_STYLESHEET_URL", "样式表 URL 错误: {0}" }, { "ER_FILE_NOT_FOUND", "找不到样式表文件: {0}" }, { "ER_IOEXCEPTION", "样式表文件出现 IO 异常错误: {0}" }, { "ER_NO_HREF_ATTRIB", "(StylesheetHandler) 找不到{0}的 href 属性" }, { "ER_STYLESHEET_INCLUDES_ITSELF", "(StylesheetHandler) {0}直接或间接包含其自身!" }, 
        { "ER_PROCESSINCLUDE_ERROR", "StylesheetHandler.processInclude 错误, {0}" }, { "ER_MISSING_LANG_ATTRIB", "(StylesheetHandler) 缺少{0}属性 ''lang''" }, { "ER_MISSING_CONTAINER_ELEMENT_COMPONENT", "(StylesheetHandler) {0}元素的放置位置是否错误?? 缺少容器元素 ''component''" }, { "ER_CAN_ONLY_OUTPUT_TO_ELEMENT", "只能输出到 Element, DocumentFragment, Document 或 PrintWriter。" }, { "ER_PROCESS_ERROR", "StylesheetRoot.process 错误" }, { "ER_UNIMPLNODE_ERROR", "UnImplNode 错误: {0}" }, { "ER_NO_SELECT_EXPRESSION", "错误! 找不到 xpath 选择表达式 (-select)。" }, { "ER_CANNOT_SERIALIZE_XSLPROCESSOR", "无法序列化 XSLProcessor!" }, { "ER_NO_INPUT_STYLESHEET", "未指定样式表输入!" }, { "ER_FAILED_PROCESS_STYLESHEET", "无法处理样式表!" }, 
        { "ER_COULDNT_PARSE_DOC", "无法解析{0}文档!" }, { "ER_COULDNT_FIND_FRAGMENT", "找不到片段: {0}" }, { "ER_NODE_NOT_ELEMENT", "片段标识符指向的节点不是元素: {0}" }, { "ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB", "for-each 必须具有 match 或 name 属性" }, { "ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB", "templates 必须具有 match 或 name 属性" }, { "ER_NO_CLONE_OF_DOCUMENT_FRAG", "不能克隆文档片段!" }, { "ER_CANT_CREATE_ITEM", "无法在结果树中创建项: {0}" }, { "ER_XMLSPACE_ILLEGAL_VALUE", "源 XML 中的 xml:space 具有非法值: {0}" }, { "ER_NO_XSLKEY_DECLARATION", "{0}没有 xsl:key 声明!" }, { "ER_CANT_CREATE_URL", "错误! 无法为{0}创建 url" }, 
        { "ER_XSLFUNCTIONS_UNSUPPORTED", "不支持 xsl:functions" }, { "ER_PROCESSOR_ERROR", "XSLT TransformerFactory 错误" }, { "ER_NOT_ALLOWED_INSIDE_STYLESHEET", "(StylesheetHandler) 样式表中不允许使用{0}!" }, { "ER_RESULTNS_NOT_SUPPORTED", "不再支持 result-ns! 请改用 xsl:output。" }, { "ER_DEFAULTSPACE_NOT_SUPPORTED", "不再支持 default-space! 请改用 xsl:strip-space 或 xsl:preserve-space。" }, { "ER_INDENTRESULT_NOT_SUPPORTED", "不再支持 indent-result! 请改用 xsl:output。" }, { "ER_ILLEGAL_ATTRIB", "(StylesheetHandler) {0}具有非法属性: {1}" }, { "ER_UNKNOWN_XSL_ELEM", "未知 XSL 元素: {0}" }, { "ER_BAD_XSLSORT_USE", "(StylesheetHandler) xsl:sort 只能与 xsl:apply-templates 或 xsl:for-each 一起使用。" }, { "ER_MISPLACED_XSLWHEN", "(StylesheetHandler) xsl:when 的放置位置错误!" }, 
        { "ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:when 的父级不是 xsl:choose!" }, { "ER_MISPLACED_XSLOTHERWISE", "(StylesheetHandler) xsl:otherwise 的放置位置错误!" }, { "ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:otherwise 的父级不是 xsl:choose!" }, { "ER_NOT_ALLOWED_INSIDE_TEMPLATE", "(StylesheetHandler) 模板中不允许使用{0}!" }, { "ER_UNKNOWN_EXT_NS_PREFIX", "(StylesheetHandler) {0}扩展名称空间前缀 {1} 未知" }, { "ER_IMPORTS_AS_FIRST_ELEM", "(StylesheetHandler) 只能作为样式表中的第一个元素导入!" }, { "ER_IMPORTING_ITSELF", "(StylesheetHandler) {0}直接或间接导入其自身!" }, { "ER_XMLSPACE_ILLEGAL_VAL", "(StylesheetHandler) xml:space 具有非法值: {0}" }, { "ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL", "processStylesheet 失败!" }, { "ER_SAX_EXCEPTION", "SAX 异常错误" }, 
        { "ER_FUNCTION_NOT_SUPPORTED", "不支持该函数!" }, { "ER_XSLT_ERROR", "XSLT 错误" }, { "ER_CURRENCY_SIGN_ILLEGAL", "格式模式字符串中不允许使用货币符号" }, { "ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM", "样式表 DOM 中不支持 Document 函数!" }, { "ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER", "无法解析非前缀解析器的前缀!" }, { "ER_REDIRECT_COULDNT_GET_FILENAME", "重定向扩展: 无法获取文件名 - file 或 select 属性必须返回有效字符串。" }, { "ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT", "无法在重定向扩展中构建 FormatterListener!" }, { "ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX", "exclude-result-prefixes 中的前缀无效: {0}" }, { "ER_MISSING_NS_URI", "指定前缀缺少名称空间 URI" }, { "ER_MISSING_ARG_FOR_OPTION", "选项缺少参数: {0}" }, 
        { "ER_INVALID_OPTION", "选项无效: {0}" }, { "ER_MALFORMED_FORMAT_STRING", "格式字符串的格式错误: {0}" }, { "ER_STYLESHEET_REQUIRES_VERSION_ATTRIB", "xsl:stylesheet 需要 'version' 属性!" }, { "ER_ILLEGAL_ATTRIBUTE_VALUE", "属性{0}具有非法值: {1}" }, { "ER_CHOOSE_REQUIRES_WHEN", "xsl:choose 需要 xsl:when" }, { "ER_NO_APPLY_IMPORT_IN_FOR_EACH", "xsl:for-each 中不允许使用 xsl:apply-imports" }, { "ER_CANT_USE_DTM_FOR_OUTPUT", "无法将 DTMLiaison 用于输出 DOM 节点... 请改为传递 com.sun.org.apache.xpath.internal.DOM2Helper!" }, { "ER_CANT_USE_DTM_FOR_INPUT", "无法将 DTMLiaison 用于输入 DOM 节点... 请改为传递 com.sun.org.apache.xpath.internal.DOM2Helper!" }, { "ER_CALL_TO_EXT_FAILED", "未能调用扩展元素: {0}" }, { "ER_PREFIX_MUST_RESOLVE", "前缀必须解析为名称空间: {0}" }, 
        { "ER_INVALID_UTF16_SURROGATE", "检测到无效的 UTF-16 代理: {0}?" }, { "ER_XSLATTRSET_USED_ITSELF", "xsl:attribute-set {0} 使用其自身, 这将导致无限循环。" }, { "ER_CANNOT_MIX_XERCESDOM", "无法混合非 Xerces-DOM 输入和 Xerces-DOM 输出!" }, { "ER_TOO_MANY_LISTENERS", "addTraceListenersToStylesheet - TooManyListenersException" }, { "ER_IN_ELEMTEMPLATEELEM_READOBJECT", "在 ElemTemplateElement.readObject 中: {0}" }, { "ER_DUPLICATE_NAMED_TEMPLATE", "找到多个名为{0}的模板" }, { "ER_INVALID_KEY_CALL", "函数调用无效: 不允许递归 key() 调用" }, { "ER_REFERENCING_ITSELF", "变量 {0} 直接或间接引用其自身!" }, { "ER_ILLEGAL_DOMSOURCE_INPUT", "对于 newTemplates 的 DOMSource, 输入节点不能为空值!" }, { "ER_CLASS_NOT_FOUND_FOR_OPTION", "找不到选项{0}的类文件" }, 
        { "ER_REQUIRED_ELEM_NOT_FOUND", "找不到所需元素: {0}" }, { "ER_INPUT_CANNOT_BE_NULL", "InputStream 不能为空值" }, { "ER_URI_CANNOT_BE_NULL", "URI 不能为空值" }, { "ER_FILE_CANNOT_BE_NULL", "File 不能为空值" }, { "ER_SOURCE_CANNOT_BE_NULL", "InputSource 不能为空值" }, { "ER_CANNOT_INIT_BSFMGR", "无法初始化 BSF 管理器" }, { "ER_CANNOT_CMPL_EXTENSN", "无法编译扩展" }, { "ER_CANNOT_CREATE_EXTENSN", "无法创建扩展: {0}, 原因: {1}" }, { "ER_INSTANCE_MTHD_CALL_REQUIRES", "对方法{0}的实例方法调用需要将 Object 实例作为第一个参数" }, { "ER_INVALID_ELEMENT_NAME", "指定的元素名称{0}无效" }, 
        { "ER_ELEMENT_NAME_METHOD_STATIC", "元素名称方法必须是 static {0}" }, { "ER_EXTENSION_FUNC_UNKNOWN", "扩展函数 {0}: {1} 未知" }, { "ER_MORE_MATCH_CONSTRUCTOR", "{0}的构造器具有多个最佳匹配" }, { "ER_MORE_MATCH_METHOD", "方法{0}具有多个最佳匹配" }, { "ER_MORE_MATCH_ELEMENT", "元素方法{0}具有多个最佳匹配" }, { "ER_INVALID_CONTEXT_PASSED", "传递的用于对{0}求值的上下文无效" }, { "ER_POOL_EXISTS", "池已存在" }, { "ER_NO_DRIVER_NAME", "未指定驱动程序名称" }, { "ER_NO_URL", "未指定 URL" }, { "ER_POOL_SIZE_LESSTHAN_ONE", "池大小小于 1!" }, 
        { "ER_INVALID_DRIVER", "指定的驱动程序名称无效!" }, { "ER_NO_STYLESHEETROOT", "找不到样式表根!" }, { "ER_ILLEGAL_XMLSPACE_VALUE", "xml:space 的值非法" }, { "ER_PROCESSFROMNODE_FAILED", "processFromNode 失败" }, { "ER_RESOURCE_COULD_NOT_LOAD", "资源 [ {0} ] 无法加载: {1} \n {2} \t {3}" }, { "ER_BUFFER_SIZE_LESSTHAN_ZERO", "缓冲区大小 <=0" }, { "ER_UNKNOWN_ERROR_CALLING_EXTENSION", "调用扩展时出现未知错误" }, { "ER_NO_NAMESPACE_DECL", "前缀 {0} 没有对应的名称空间声明" }, { "ER_ELEM_CONTENT_NOT_ALLOWED", "lang=javaclass {0}不允许使用元素内容" }, { "ER_STYLESHEET_DIRECTED_TERMINATION", "样式表指向终止" }, 
