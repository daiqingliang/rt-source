...
public class XSLTErrorResources_zh_TW extends ListResourceBundle {
  ...
  public Object[][] getContents() { return new Object[][] { 
        { "ER0000", "{0}" }, { "ER_NO_CURLYBRACE", "錯誤: 表示式中不可有 '{'" }, { "ER_ILLEGAL_ATTRIBUTE", "{0} 具有無效屬性: {1}" }, { "ER_NULL_SOURCENODE_APPLYIMPORTS", "sourceNode 在 xsl:apply-imports 中是空值！" }, { "ER_CANNOT_ADD", "無法新增 {0} 至 {1}" }, { "ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES", "sourceNode 在 handleApplyTemplatesInstruction 中是空值！" }, { "ER_NO_NAME_ATTRIB", "{0} 必須有名稱屬性。" }, { "ER_TEMPLATE_NOT_FOUND", "找不到下列名稱的樣板: {0}" }, { "ER_CANT_RESOLVE_NAME_AVT", "無法解析 xsl:call-template 中的名稱 AVT。" }, { "ER_REQUIRES_ATTRIB", "{0} 需要屬性: {1}" }, 
        { "ER_MUST_HAVE_TEST_ATTRIB", "{0} 必須有 ''test'' 屬性。" }, { "ER_BAD_VAL_ON_LEVEL_ATTRIB", "錯誤的值位於層次屬性: {0}" }, { "ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML", "processing-instruction 名稱不可為 'xml'" }, { "ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME", "processing-instruction 名稱必須是有效的 NCName: {0}" }, { "ER_NEED_MATCH_ATTRIB", "{0} 若具有模式，則必須有配對屬性。" }, { "ER_NEED_NAME_OR_MATCH_ATTRIB", "{0} 需要名稱或配對屬性。" }, { "ER_CANT_RESOLVE_NSPREFIX", "無法解析命名空間前置碼: {0}" }, { "ER_ILLEGAL_VALUE", "xml:space 具有無效值: {0}" }, { "ER_NO_OWNERDOC", "子項節點不具有擁有者文件！" }, { "ER_ELEMTEMPLATEELEM_ERR", "ElemTemplateElement 錯誤: {0}" }, 
        { "ER_NULL_CHILD", "嘗試新增空值子項！" }, { "ER_NEED_SELECT_ATTRIB", "{0} 需要選取屬性。" }, { "ER_NEED_TEST_ATTRIB", "xsl:when 必須具有 'test' 屬性。" }, { "ER_NEED_NAME_ATTRIB", "xsl:with-param 必須具有 'name' 屬性。" }, { "ER_NO_CONTEXT_OWNERDOC", "相關資訊環境不具有擁有者文件！" }, { "ER_COULD_NOT_CREATE_XML_PROC_LIAISON", "無法建立 XML TransformerFactory Liaison: {0}" }, { "ER_PROCESS_NOT_SUCCESSFUL", "Xalan: 處理作業失敗。" }, { "ER_NOT_SUCCESSFUL", "Xalan: 失敗！" }, { "ER_ENCODING_NOT_SUPPORTED", "不支援編碼: {0}" }, { "ER_COULD_NOT_CREATE_TRACELISTENER", "無法建立 TraceListener: {0}" }, 
        { "ER_KEY_REQUIRES_NAME_ATTRIB", "xsl:key 需要 'name' 屬性！" }, { "ER_KEY_REQUIRES_MATCH_ATTRIB", "xsl:key 需要 'match' 屬性！" }, { "ER_KEY_REQUIRES_USE_ATTRIB", "xsl:key 需要 'use' 屬性！" }, { "ER_REQUIRES_ELEMENTS_ATTRIB", "(StylesheetHandler) {0} 需要 ''elements'' 屬性！" }, { "ER_MISSING_PREFIX_ATTRIB", "(StylesheetHandler) 遺漏 {0} 屬性 ''prefix''" }, { "ER_BAD_STYLESHEET_URL", "樣式表 URL 錯誤: {0}" }, { "ER_FILE_NOT_FOUND", "找不到樣式表檔案: {0}" }, { "ER_IOEXCEPTION", "樣式表檔案發生 IO 異常狀況: {0}" }, { "ER_NO_HREF_ATTRIB", "(StylesheetHandler) 找不到 {0} 的 href 屬性" }, { "ER_STYLESHEET_INCLUDES_ITSELF", "(StylesheetHandler) {0} 直接或間接地包含本身！" }, 
        { "ER_PROCESSINCLUDE_ERROR", "StylesheetHandler.processInclude 錯誤，{0}" }, { "ER_MISSING_LANG_ATTRIB", "(StylesheetHandler) 遺漏 {0} 屬性 ''lang''" }, { "ER_MISSING_CONTAINER_ELEMENT_COMPONENT", "(StylesheetHandler) {0} 元素的位置錯誤？遺漏容器元素 ''component''" }, { "ER_CAN_ONLY_OUTPUT_TO_ELEMENT", "只能輸出至 Element、DocumentFragment、Document 或 PrintWriter。" }, { "ER_PROCESS_ERROR", "StylesheetRoot.process 錯誤" }, { "ER_UNIMPLNODE_ERROR", "UnImplNode 錯誤: {0}" }, { "ER_NO_SELECT_EXPRESSION", "錯誤！找不到 xpath 選取表示式 (-select)。" }, { "ER_CANNOT_SERIALIZE_XSLPROCESSOR", "無法序列化 XSLProcessor！" }, { "ER_NO_INPUT_STYLESHEET", "未指定樣式表輸入！" }, { "ER_FAILED_PROCESS_STYLESHEET", "無法處理樣式表！" }, 
        { "ER_COULDNT_PARSE_DOC", "無法剖析 {0} 文件！" }, { "ER_COULDNT_FIND_FRAGMENT", "找不到片段: {0}" }, { "ER_NODE_NOT_ELEMENT", "片段 ID 指向的節點不是元素: {0}" }, { "ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB", "for-each 必須有配對或名稱屬性" }, { "ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB", "樣板必須有配對或名稱屬性" }, { "ER_NO_CLONE_OF_DOCUMENT_FRAG", "沒有文件片段的複製！" }, { "ER_CANT_CREATE_ITEM", "無法在結果樹狀結構中建立項目: {0}" }, { "ER_XMLSPACE_ILLEGAL_VALUE", "來源 XML 中的 xml:space 具有無效值: {0}" }, { "ER_NO_XSLKEY_DECLARATION", "{0} 沒有 xsl:key 宣告！" }, { "ER_CANT_CREATE_URL", "錯誤！無法為 {0} 建立 url" }, 
        { "ER_XSLFUNCTIONS_UNSUPPORTED", "不支援 xsl:functions" }, { "ER_PROCESSOR_ERROR", "XSLT TransformerFactory 錯誤" }, { "ER_NOT_ALLOWED_INSIDE_STYLESHEET", "(StylesheetHandler) 樣式表內不允許 {0}！" }, { "ER_RESULTNS_NOT_SUPPORTED", "不再支援 result-ns！請改用 xsl:output。" }, { "ER_DEFAULTSPACE_NOT_SUPPORTED", "不再支援 default-space！請改用 xsl:strip-space 或 xsl:preserve-space。" }, { "ER_INDENTRESULT_NOT_SUPPORTED", "不再支援 indent-result！請改用 xsl:output。" }, { "ER_ILLEGAL_ATTRIB", "(StylesheetHandler) {0} 具有無效屬性: {1}" }, { "ER_UNKNOWN_XSL_ELEM", "不明的 XSL 元素: {0}" }, { "ER_BAD_XSLSORT_USE", "(StylesheetHandler) xsl:sort 只能與 xsl:apply-templates 或 xsl:for-each 一起使用。" }, { "ER_MISPLACED_XSLWHEN", "(StylesheetHandler) xsl:when 位置錯誤！" }, 
        { "ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:when 的父項不是 xsl:choose！" }, { "ER_MISPLACED_XSLOTHERWISE", "(StylesheetHandler) xsl:otherwise 位置錯誤！" }, { "ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:otherwise 的父項不是 xsl:choose！" }, { "ER_NOT_ALLOWED_INSIDE_TEMPLATE", "(StylesheetHandler) 樣板內不允許 {0}！" }, { "ER_UNKNOWN_EXT_NS_PREFIX", "(StylesheetHandler) 不明的 {0} 擴充套件命名空間前置碼 {1}" }, { "ER_IMPORTS_AS_FIRST_ELEM", "(StylesheetHandler) 匯入只能發生於樣式表中的第一個元素！" }, { "ER_IMPORTING_ITSELF", "(StylesheetHandler) {0} 直接或間接地匯入本身！" }, { "ER_XMLSPACE_ILLEGAL_VAL", "(StylesheetHandler) xml:space 具有無效值: {0}" }, { "ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL", "processStylesheet 失敗！" }, { "ER_SAX_EXCEPTION", "SAX 異常狀況" }, 
        { "ER_FUNCTION_NOT_SUPPORTED", "不支援函數！" }, { "ER_XSLT_ERROR", "XSLT 錯誤" }, { "ER_CURRENCY_SIGN_ILLEGAL", "格式樣式字串中不允許貨幣符號" }, { "ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM", "Stylesheet DOM 中不支援文件函數！" }, { "ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER", "無法解析非前置碼解析器的前置碼！" }, { "ER_REDIRECT_COULDNT_GET_FILENAME", "重導擴充套件: 無法取得檔案名稱 - 檔案或選取屬性必須傳回有效字串。" }, { "ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT", "無法在重導擴充套件中建立 FormatterListener！" }, { "ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX", "exclude-result-prefixes 中的前置碼無效: {0}" }, { "ER_MISSING_NS_URI", "遺漏指定前置碼的命名空間 URI" }, { "ER_MISSING_ARG_FOR_OPTION", "遺漏選項的引數: {0}" }, 
        { "ER_INVALID_OPTION", "無效的選項: {0}" }, { "ER_MALFORMED_FORMAT_STRING", "格式錯誤的格式字串: {0}" }, { "ER_STYLESHEET_REQUIRES_VERSION_ATTRIB", "xsl:stylesheet 需要 'version' 屬性！" }, { "ER_ILLEGAL_ATTRIBUTE_VALUE", "屬性: {0} 具有無效值: {1}" }, { "ER_CHOOSE_REQUIRES_WHEN", "xsl:choose 需要 xsl:when" }, { "ER_NO_APPLY_IMPORT_IN_FOR_EACH", "xsl:for-each 中不允許 xsl:apply-imports" }, { "ER_CANT_USE_DTM_FOR_OUTPUT", "DTMLiaison 無法用於輸出 DOM 節點。請改為傳送 com.sun.org.apache.xpath.internal.DOM2Helper！" }, { "ER_CANT_USE_DTM_FOR_INPUT", "DTMLiaison 無法用於輸入 DOM 節點。請改為傳送 com.sun.org.apache.xpath.internal.DOM2Helper！" }, { "ER_CALL_TO_EXT_FAILED", "呼叫擴充套件元素失敗: {0}" }, { "ER_PREFIX_MUST_RESOLVE", "前置碼必須解析為命名空間: {0}" }, 
        { "ER_INVALID_UTF16_SURROGATE", "偵測到無效的 UTF-16 代理: {0}？" }, { "ER_XSLATTRSET_USED_ITSELF", "xsl:attribute-set {0} 使用本身，如此將造成無限迴圈。" }, { "ER_CANNOT_MIX_XERCESDOM", "無法混合非 Xerces-DOM 輸入與 Xerces-DOM 輸出！" }, { "ER_TOO_MANY_LISTENERS", "addTraceListenersToStylesheet - TooManyListenersException" }, { "ER_IN_ELEMTEMPLATEELEM_READOBJECT", "在 ElemTemplateElement.readObject 中: {0}" }, { "ER_DUPLICATE_NAMED_TEMPLATE", "找到超過一個下列名稱的樣板: {0}" }, { "ER_INVALID_KEY_CALL", "無效的函數呼叫: 不允許遞迴 key() 呼叫" }, { "ER_REFERENCING_ITSELF", "變數 {0} 直接或間接地參照本身！" }, { "ER_ILLEGAL_DOMSOURCE_INPUT", "newTemplates 之 DOMSource 的輸入節點不可為空值！" }, { "ER_CLASS_NOT_FOUND_FOR_OPTION", "找不到選項 {0} 的類別檔案" }, 
        { "ER_REQUIRED_ELEM_NOT_FOUND", "找不到需要的元素: {0}" }, { "ER_INPUT_CANNOT_BE_NULL", "InputStream 不可為空值" }, { "ER_URI_CANNOT_BE_NULL", "URI 不可為空值" }, { "ER_FILE_CANNOT_BE_NULL", "File 不可為空值" }, { "ER_SOURCE_CANNOT_BE_NULL", "InputSource 不可為空值" }, { "ER_CANNOT_INIT_BSFMGR", "無法起始 BSF 管理程式" }, { "ER_CANNOT_CMPL_EXTENSN", "無法編譯擴充套件" }, { "ER_CANNOT_CREATE_EXTENSN", "無法建立擴充套件: {0}，因為: {1}" }, { "ER_INSTANCE_MTHD_CALL_REQUIRES", "執行處理方法呼叫方法 {0} 時，需要 Object 執行處理作為第一個引數" }, { "ER_INVALID_ELEMENT_NAME", "指定了無效的元素名稱 {0}" }, 
        { "ER_ELEMENT_NAME_METHOD_STATIC", "元素名稱方法必須是靜態 {0}" }, { "ER_EXTENSION_FUNC_UNKNOWN", "擴充套件函數 {0} : {1} 不明" }, { "ER_MORE_MATCH_CONSTRUCTOR", "{0} 的建構子有超過一個以上的最佳配對" }, { "ER_MORE_MATCH_METHOD", "方法 {0} 有超過一個以上的最佳配對" }, { "ER_MORE_MATCH_ELEMENT", "元素方法 {0} 有超過一個以上的最佳配對" }, { "ER_INVALID_CONTEXT_PASSED", "傳送了無效的相關資訊環境來評估 {0}" }, { "ER_POOL_EXISTS", "集區已經存在" }, { "ER_NO_DRIVER_NAME", "未指定驅動程式名稱" }, { "ER_NO_URL", "未指定 URL" }, { "ER_POOL_SIZE_LESSTHAN_ONE", "集區大小小於一！" }, 
        { "ER_INVALID_DRIVER", "指定了無效的驅動程式名稱！" }, { "ER_NO_STYLESHEETROOT", "找不到樣式表根！" }, { "ER_ILLEGAL_XMLSPACE_VALUE", "xml:space 的值無效" }, { "ER_PROCESSFROMNODE_FAILED", "processFromNode 失敗" }, { "ER_RESOURCE_COULD_NOT_LOAD", "無法載入資源 [ {0} ]: {1} \n {2} \t {3}" }, { "ER_BUFFER_SIZE_LESSTHAN_ZERO", "緩衝區大小 <=0" }, { "ER_UNKNOWN_ERROR_CALLING_EXTENSION", "呼叫擴充套件時，發生不明的錯誤" }, { "ER_NO_NAMESPACE_DECL", "前置碼 {0} 沒有對應的命名空間宣告" }, { "ER_ELEM_CONTENT_NOT_ALLOWED", "元素內容不允許 lang=javaclass {0}" }, { "ER_STYLESHEET_DIRECTED_TERMINATION", "樣式表導向的終止" }, 
        { "ER_ONE_OR_TWO", "1 或 2" }, { "ER_TWO_OR_THREE", "2 或 3" }, { "ER_COULD_NOT_LOAD_RESOURCE", "無法載入 {0} (檢查 CLASSPATH)，目前只使用預設值" }, { "ER_CANNOT_INIT_DEFAULT_TEMPLATES", "無法起始預設樣板" }, { "ER_RESULT_NULL", "結果不應為空值" }, { "ER_RESULT_COULD_NOT_BE_SET", "無法設定結果" }, { "ER_NO_OUTPUT_SPECIFIED", "未指定輸出" }, { "ER_CANNOT_TRANSFORM_TO_RESULT_TYPE", "無法轉換為類型 {0} 的結果" }, { "ER_CANNOT_TRANSFORM_SOURCE_TYPE", "無法轉換類型 {0} 的來源" }, { "ER_NULL_CONTENT_HANDLER", "空值內容處理程式" }, 
        { "ER_NULL_ERROR_HANDLER", "空值錯誤處理程式" }, { "ER_CANNOT_CALL_PARSE", "若未設定 ContentHandler，則無法呼叫剖析" }, { "ER_NO_PARENT_FOR_FILTER", "篩選沒有父項" }, { "ER_NO_STYLESHEET_IN_MEDIA", "在 {0} 中找不到樣式表，媒體 = {1}" }, { "ER_NO_STYLESHEET_PI", "在 {0} 中找不到 xml-stylesheet PI" }, { "ER_NOT_SUPPORTED", "不支援: {0}" }, { "ER_PROPERTY_VALUE_BOOLEAN", "屬性 {0} 的值應為布林執行處理" }, { "ER_COULD_NOT_FIND_EXTERN_SCRIPT", "無法在 {0} 取得外部命令檔" }, { "ER_RESOURCE_COULD_NOT_FIND", "找不到資源 [ {0} ]。\n{1}" }, { "ER_OUTPUT_PROPERTY_NOT_RECOGNIZED", "無法辨識的輸出屬性: {0}" }, 
        { "ER_FAILED_CREATING_ELEMLITRSLT", "無法建立 ElemLiteralResult 執行處理" }, { "ER_VALUE_SHOULD_BE_NUMBER", "{0} 的值應包含可剖析的數字" }, { "ER_VALUE_SHOULD_EQUAL", "{0} 的值應等於 yes 或 no" }, { "ER_FAILED_CALLING_METHOD", "無法呼叫 {0} 方法" }, { "ER_FAILED_CREATING_ELEMTMPL", "無法建立 ElemTemplateElement 執行處理" }, { "ER_CHARS_NOT_ALLOWED", "文件此處不允許字元" }, { "ER_ATTR_NOT_ALLOWED", "{1} 元素不允許 \"{0}\" 屬性！" }, { "ER_BAD_VALUE", "{0} 無效值 {1} " }, { "ER_ATTRIB_VALUE_NOT_FOUND", "找不到 {0} 屬性值" }, { "ER_ATTRIB_VALUE_NOT_RECOGNIZED", "{0} 屬性值無法辨識 " }, 
        { "ER_NULL_URI_NAMESPACE", "嘗試以空值 URI 產生命名空間前置碼" }, { "ER_NUMBER_TOO_BIG", "嘗試格式化大於最大長整數的數字" }, { "ER_CANNOT_FIND_SAX1_DRIVER", "找不到 SAX1 驅動程式類別 {0}" }, { "ER_SAX1_DRIVER_NOT_LOADED", "找到 SAX1 驅動程式類別 {0}，但無法載入" }, { "ER_SAX1_DRIVER_NOT_INSTANTIATED", "已載入 SAX1 驅動程式類別 {0}，但無法建立" }, { "ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER", "SAX1 驅動程式類別 {0} 未實行 org.xml.sax.Parser" }, { "ER_PARSER_PROPERTY_NOT_SPECIFIED", "未指定系統屬性 org.xml.sax.parser" }, { "ER_PARSER_ARG_CANNOT_BE_NULL", "剖析器引數不可為空值" }, { "ER_FEATURE", "功能: {0}" }, { "ER_PROPERTY", "屬性: {0}" }, 
        { "ER_NULL_ENTITY_RESOLVER", "空值實體解析器" }, { "ER_NULL_DTD_HANDLER", "空值 DTD 處理程式" }, { "ER_NO_DRIVER_NAME_SPECIFIED", "未指定驅動程式名稱！" }, { "ER_NO_URL_SPECIFIED", "未指定 URL！" }, { "ER_POOLSIZE_LESS_THAN_ONE", "集區大小小於 1！" }, { "ER_INVALID_DRIVER_NAME", "指定了無效的驅動程式名稱！" }, { "ER_ERRORLISTENER", "ErrorListener" }, { "ER_ASSERT_NO_TEMPLATE_PARENT", "程式設計人員的錯誤！表示式沒有 ElemTemplateElement 父項！" }, { "ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR", "程式設計人員在 RedundentExprEliminator 中的宣告: {0}" }, { "ER_NOT_ALLOWED_IN_POSITION", "樣式表此位置不允許 {0}！" }, 
        { "ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION", "樣式表此位置不允許非空格文字！" }, { "INVALID_TCHAR", "無效值: {1} 用於 CHAR 屬性: {0}。類型 CHAR 的屬性必須僅為 1 個字元！" }, { "INVALID_QNAME", "無效值: {1} 用於 QNAME 屬性: {0}" }, { "INVALID_ENUM", "無效值: {1} 用於 ENUM 屬性: {0}。有效值為: {2}。" }, { "INVALID_NMTOKEN", "無效值: {1} 用於 NMTOKEN 屬性: {0}" }, { "INVALID_NCNAME", "無效值: {1} 用於 NCNAME 屬性: {0}" }, { "INVALID_BOOLEAN", "無效值: {1} 用於布林屬性: {0}" }, { "INVALID_NUMBER", "無效值: {1} 用於數字屬性: {0}" }, { "ER_ARG_LITERAL", "配對樣式中 {0} 的引數必須是文字。" }, { "ER_DUPLICATE_GLOBAL_VAR", "重複的全域變數宣告。" }, 
        { "ER_DUPLICATE_VAR", "重複的變數宣告。" }, { "ER_TEMPLATE_NAME_MATCH", "xsl:template 必須有名稱或配對屬性 (或具有兩者)" }, { "ER_INVALID_PREFIX", "exclude-result-prefixes 中的前置碼無效: {0}" }, { "ER_NO_ATTRIB_SET", "不存在名稱為 {0} 的 attribute-set" }, { "ER_FUNCTION_NOT_FOUND", "不存在名稱為 {0} 的函數" }, { "ER_CANT_HAVE_CONTENT_AND_SELECT", "{0} 元素不可同時具有內容與選取屬性。" }, { "ER_INVALID_SET_PARAM_VALUE", "參數 {0} 的值必須是有效的 Java 物件" }, { "ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT", "xsl:namespace-alias 元素的 result-prefix 屬性具有值 '#default'，但是元素範圍中沒有預設命名空間的宣告" }, { "ER_INVALID_SET_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX", "xsl:namespace-alias 元素的 result-prefix 屬性具有值 ''{0}''，但是元素範圍中沒有前置碼 ''{0}'' 的命名空間宣告。" }, { "ER_SET_FEATURE_NULL_NAME", "TransformerFactory.setFeature(字串名稱, 布林值) 中的功能名稱不可為空值。" }, 
        { "ER_GET_FEATURE_NULL_NAME", "TransformerFactory.getFeature(字串名稱) 中的功能名稱不可為空值。" }, { "ER_UNSUPPORTED_FEATURE", "無法在此 TransformerFactory 上設定功能 ''{0}''。" }, { "ER_EXTENSION_ELEMENT_NOT_ALLOWED_IN_SECURE_PROCESSING", "當安全處理功能設為真時，不允許使用擴充套件元素 ''{0}''。" }, { "ER_NAMESPACE_CONTEXT_NULL_NAMESPACE", "無法取得空值命名空間 uri 的前置碼。" }, { "ER_NAMESPACE_CONTEXT_NULL_PREFIX", "無法取得空值前置碼的命名空間 uri。" }, { "ER_XPATH_RESOLVER_NULL_QNAME", "函數名稱不可為空值。" }, { "ER_XPATH_RESOLVER_NEGATIVE_ARITY", "Arity 不可為負值。" }, { "WG_FOUND_CURLYBRACE", "找到 '}'，但沒有開啟的屬性樣板！" }, { "WG_COUNT_ATTRIB_MATCHES_NO_ANCESTOR", "警告: 計數屬性不符合 xsl:number 中的祖系！目標 = {0}" }, { "WG_EXPR_ATTRIB_CHANGED_TO_SELECT", "舊語法: 'expr' 屬性的名稱已變更為 'select'。" }, 
        { "WG_NO_LOCALE_IN_FORMATNUMBER", "Xalan 尚未處理 format-number 函數中的地區設定名稱。" }, { "WG_LOCALE_NOT_FOUND", "警告: 找不到 xml:lang={0} 的地區設定" }, { "WG_CANNOT_MAKE_URL_FROM", "無法從 {0} 建立 URL" }, { "WG_CANNOT_LOAD_REQUESTED_DOC", "無法載入要求的文件: {0}" }, { "WG_CANNOT_FIND_COLLATOR", "找不到 <sort xml:lang={0} 的 Collator" }, { "WG_FUNCTIONS_SHOULD_USE_URL", "舊語法: 函數指示應使用 {0} 的 url" }, { "WG_ENCODING_NOT_SUPPORTED_USING_UTF8", "不支援編碼: {0}，使用 UTF-8" }, { "WG_ENCODING_NOT_SUPPORTED_USING_JAVA", "不支援編碼: {0}，使用 Java {1}" }, { "WG_SPECIFICITY_CONFLICTS", "發現指定衝突: {0} 將使用樣式表中最後找到的項目。" }, { "WG_PARSING_AND_PREPARING", "========= 剖析與準備 {0} ==========" }, 
        { "WG_ATTR_TEMPLATE", "屬性樣板，{0}" }, { "WG_CONFLICT_BETWEEN_XSLSTRIPSPACE_AND_XSLPRESERVESP", "xsl:strip-space 與 xsl:preserve-space 之間配對衝突" }, { "WG_ATTRIB_NOT_HANDLED", "Xalan 尚未處理 {0} 屬性！" }, { "WG_NO_DECIMALFORMAT_DECLARATION", "找不到十進位格式的宣告: {0}" }, { "WG_OLD_XSLT_NS", "遺漏或不正確的 XSLT 命名空間。" }, { "WG_ONE_DEFAULT_XSLDECIMALFORMAT_ALLOWED", "只允許一個預設的 xsl:decimal-format 宣告。" }, { "WG_XSLDECIMALFORMAT_NAMES_MUST_BE_UNIQUE", "xsl:decimal-format 名稱必須是唯一的名稱。名稱 \"{0}\" 重複。" }, { "WG_ILLEGAL_ATTRIBUTE", "{0} 具有無效屬性: {1}" }, { "WG_COULD_NOT_RESOLVE_PREFIX", "無法解析命名空間前置碼: {0}。將忽略此節點。" }, { "WG_STYLESHEET_REQUIRES_VERSION_ATTRIB", "xsl:stylesheet 需要 'version' 屬性！" }, 
        { "WG_ILLEGAL_ATTRIBUTE_NAME", "無效的屬性名稱: {0}" }, { "WG_ILLEGAL_ATTRIBUTE_VALUE", "用於屬性 {0} 的無效值: {1}" }, { "WG_EMPTY_SECOND_ARG", "文件函數第二個引數產生的節點集為空白。傳回空白的 node-set。" }, { "WG_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML", "xsl:processing-instruction 名稱的 'name' 屬性值不可為 'xml'" }, { "WG_PROCESSINGINSTRUCTION_NOTVALID_NCNAME", "xsl:processing-instruction 的 ''name'' 屬性值必須是有效的 NCName: {0}" }, { "WG_ILLEGAL_ATTRIBUTE_POSITION", "在產生子項節點之後，或在產生元素之前，不可新增屬性 {0}。屬性會被忽略。" }, { "NO_MODIFICATION_ALLOWED_ERR", "嘗試修改不允許修改的物件。" }, { "ui_language", "tw" }, { "help_language", "tw" }, { "language", "tw" }, 
        { "BAD_CODE", "createMessage 的參數超出範圍" }, { "FORMAT_FAILED", "messageFormat 呼叫期間發生異常狀況" }, { "version", ">>>>>>> Xalan 版本 " }, { "version2", "<<<<<<<" }, { "yes", "是" }, { "line", "行號" }, { "column", "資料欄編號" }, { "xsldone", "XSLProcessor: 完成" }, { "xslProc_option", "Xalan-J 命令行處理作業類別選項:" }, { "xslProc_option", "Xalan-J 命令行處理作業類別選項:" }, 
        { "xslProc_invalid_xsltc_option", "XSLTC 模式中不支援選項 {0}。" }, { "xslProc_invalid_xalan_option", "選項 {0} 只能與 -XSLTC 一起使用。" }, { "xslProc_no_input", "錯誤: 未指定樣式表或輸入 xml。不使用任何選項來執行此命令，可取得用法指示。" }, { "xslProc_common_options", "-一般選項-" }, { "xslProc_xalan_options", "-Xalan 的選項-" }, { "xslProc_xsltc_options", "-XSLTC 的選項-" }, { "xslProc_return_to_continue", "(按 <return> 以繼續)" }, { "optionXSLTC", "   [-XSLTC (使用 XSLTC 進行轉換)]" }, { "optionIN", "   [-IN inputXMLURL]" }, { "optionXSL", "   [-XSL XSLTransformationURL]" }, 
        { "optionOUT", "   [-OUT outputFileName]" }, { "optionLXCIN", "   [-LXCIN compiledStylesheetFileNameIn]" }, { "optionLXCOUT", "   [-LXCOUT compiledStylesheetFileNameOutOut]" }, { "optionPARSER", "   [-PARSER 剖析器聯絡的完整類別名稱]" }, { "optionE", "   [-E (勿展開實體參照)]" }, { "optionV", "   [-E (勿展開實體參照)]" }, { "optionQC", "   [-QC (靜音樣式衝突警告)]" }, { "optionQ", "   [-Q  (靜音模式)]" }, { "optionLF", "   [-LF (輸出上僅使用換行字元 {預設為 CR/LF})]" }, { "optionCR", "   [-CR (輸出上僅使用歸位字元 {預設為 CR/LF})]" }, 
        { "optionESCAPE", "   [-ESCAPE (要遁離的字元 {預設為 <>&\"'\\r\\n}]" }, { "optionINDENT", "   [-INDENT (控制要縮排的空間 {預設為 0})]" }, { "optionTT", "   [-TT (追蹤呼叫的樣板。)]" }, { "optionTG", "   [-TG (追蹤每個產生事件。)]" }, { "optionTS", "   [-TS (追蹤每個選取事件。)]" }, { "optionTTC", "   [-TTC (追蹤處理的樣板子項。)]" }, { "optionTCLASS", "   [-TCLASS (追蹤擴充套件的 TraceListener 類別。)]" }, { "optionVALIDATE", "   [-VALIDATE (設定是否執行驗證。預設不會執行驗證。)]" }, { "optionEDUMP", "   [-EDUMP {選擇性檔案名稱} (發生錯誤時會執行堆疊傾印。)]" }, { "optionXML", "   [-XML (使用 XML 格式器並新增 XML 標頭。)]" }, 
        { "optionTEXT", "   [-TEXT (使用簡單 Text 格式器。)]" }, { "optionHTML", "   [-HTML (使用 HTML 格式器。)]" }, { "optionPARAM", "   [-PARAM 名稱表示式 (設定樣式表參數)]" }, { "noParsermsg1", "XSL 處理作業失敗。" }, { "noParsermsg2", "** 找不到剖析器 **" }, { "noParsermsg3", "請檢查類別路徑。" }, { "noParsermsg4", "若無 IBM 的 XML Parser for Java，可下載自" }, { "noParsermsg5", "IBM 的 AlphaWorks: http://www.alphaworks.ibm.com/formula/xml" }, { "optionURIRESOLVER", "   [-URIRESOLVER 完整類別名稱 (用來解析 URI 的 URIResolver)]" }, { "optionENTITYRESOLVER", "   [-ENTITYRESOLVER 完整類別名稱 (用來解析實體的 EntityResolver )]" }, 
        { "optionCONTENTHANDLER", "   [-CONTENTHANDLER 完整類別名稱 (用來序列化輸出的 ContentHandler)]" }, { "optionLINENUMBERS", "   [-L 使用行號於來源文件]" }, { "optionSECUREPROCESSING", "   [-SECURE (將安全處理功能設為真。)]" }, { "optionMEDIA", "   [-MEDIA mediaType (使用媒體屬性來尋找與文件關聯的樣式表。)]" }, { "optionFLAVOR", "   [-FLAVOR flavorName (明確使用 s2s=SAX 或 d2d=DOM 來執行轉換。)] " }, { "optionDIAG", "   [-DIAG (列印轉換所需要的全部毫秒。)]" }, { "optionINCREMENTAL", "   [-INCREMENTAL (設定 http://xml.apache.org/xalan/features/incremental 為真，以要求漸進 DTM 建構。)]" }, { "optionNOOPTIMIMIZE", "   [-NOOPTIMIMIZE (設定 http://xml.apache.org/xalan/features/optimize 為偽，以要求無樣式表最佳化處理。)]" }, { "optionRL", "   [-RL recursionlimit (宣告樣式表遞迴深度的數字限制。)]" }, { "optionXO", "   [-XO [transletName] (指派所產生 translet 的名稱)]" }, 
        { "optionXD", "   [-XD destinationDirectory (指定 translet 的目的地目錄)]" }, { "optionXJ", "   [-XJ jarfile (封裝 translet 類別成為名稱為 <jarfile> 的 jar 檔案)]" }, { "optionXP", "   [-XP 套裝程式 (指定所有產生的 translet 類別的套裝程式名稱前置碼)]" }, { "optionXN", "   [-XN (啟用樣板內嵌)]" }, { "optionXX", "   [-XX (開啟額外的除錯訊息輸出)]" }, { "optionXT", "   [-XT (若有可能，使用 translet 來轉換)]" }, { "diagTiming", " --------- 經由 {1} 的 {0} 轉換歷時 {2} 毫秒" }, { "recursionTooDeep", "樣板巢狀結構過深。巢狀結構 = {0}，樣板 {1} {2}" }, { "nameIs", "名稱為" }, { "matchPatternIs", "配對樣式為" } }; }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\org\apache\xalan\internal\res\XSLTErrorResources_zh_TW.class
