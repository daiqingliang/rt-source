...
public class XSLTErrorResources_ko extends ListResourceBundle {
  ...
  public Object[][] getContents() { return new Object[][] { 
        { "ER0000", "{0}" }, { "ER_NO_CURLYBRACE", "오류: 표현식에는 '{'가 포함될 수 없습니다." }, { "ER_ILLEGAL_ATTRIBUTE", "{0}에 잘못된 속성이 있음: {1}" }, { "ER_NULL_SOURCENODE_APPLYIMPORTS", "xsl:apply-imports의 sourceNode가 널입니다!" }, { "ER_CANNOT_ADD", "{1}에 {0}을(를) 추가할 수 없습니다." }, { "ER_NULL_SOURCENODE_HANDLEAPPLYTEMPLATES", "handleApplyTemplatesInstruction의 sourceNode가 널입니다!" }, { "ER_NO_NAME_ATTRIB", "{0}에는 name 속성이 있어야 합니다." }, { "ER_TEMPLATE_NOT_FOUND", "명명된 템플리트를 찾을 수 없음: {0}" }, { "ER_CANT_RESOLVE_NAME_AVT", "xsl:call-template에서 이름 AVT를 분석할 수 없습니다." }, { "ER_REQUIRES_ATTRIB", "{0}에 속성이 필요함: {1}" }, 
        { "ER_MUST_HAVE_TEST_ATTRIB", "{0}에는 ''test'' 속성이 있어야 합니다." }, { "ER_BAD_VAL_ON_LEVEL_ATTRIB", "level 속성에 잘못된 값이 있음: {0}" }, { "ER_PROCESSINGINSTRUCTION_NAME_CANT_BE_XML", "processing-instruction 이름은 'xml'일 수 없습니다." }, { "ER_PROCESSINGINSTRUCTION_NOTVALID_NCNAME", "processing-instruction 이름은 적합한 NCName이어야 함: {0}" }, { "ER_NEED_MATCH_ATTRIB", "{0}에 모드가 있을 경우 match 속성이 있어야 합니다." }, { "ER_NEED_NAME_OR_MATCH_ATTRIB", "{0}에는 name 또는 match 속성이 필요합니다." }, { "ER_CANT_RESOLVE_NSPREFIX", "네임스페이스 접두어를 분석할 수 없음: {0}" }, { "ER_ILLEGAL_VALUE", "xml:space에 잘못된 값이 있음: {0}" }, { "ER_NO_OWNERDOC", "하위 노드에 소유자 문서가 없습니다!" }, { "ER_ELEMTEMPLATEELEM_ERR", "ElemTemplateElement 오류: {0}" }, 
        { "ER_NULL_CHILD", "널 하위를 추가하려고 시도하는 중입니다!" }, { "ER_NEED_SELECT_ATTRIB", "{0}에는 select 속성이 필요합니다." }, { "ER_NEED_TEST_ATTRIB", "xsl:when에는 'test' 속성이 있어야 합니다." }, { "ER_NEED_NAME_ATTRIB", "xsl:with-param에는 'name' 속성이 있어야 합니다." }, { "ER_NO_CONTEXT_OWNERDOC", "컨텍스트에 소유자 문서가 없습니다!" }, { "ER_COULD_NOT_CREATE_XML_PROC_LIAISON", "XML TransformerFactory 연결을 생성할 수 없음: {0}" }, { "ER_PROCESS_NOT_SUCCESSFUL", "Xalan: 프로세스를 실패했습니다." }, { "ER_NOT_SUCCESSFUL", "Xalan: 실패했습니다." }, { "ER_ENCODING_NOT_SUPPORTED", "인코딩이 지원되지 않음: {0}" }, { "ER_COULD_NOT_CREATE_TRACELISTENER", "TraceListener를 생성할 수 없음: {0}" }, 
        { "ER_KEY_REQUIRES_NAME_ATTRIB", "xsl:key에는 'name' 속성이 필요합니다!" }, { "ER_KEY_REQUIRES_MATCH_ATTRIB", "xsl:key에는 'match' 속성이 필요합니다!" }, { "ER_KEY_REQUIRES_USE_ATTRIB", "xsl:key에는 'use' 속성이 필요합니다!" }, { "ER_REQUIRES_ELEMENTS_ATTRIB", "(StylesheetHandler) {0}에는 ''elements'' 속성이 필요합니다!" }, { "ER_MISSING_PREFIX_ATTRIB", "(StylesheetHandler) {0} 속성 ''prefix''가 누락되었습니다." }, { "ER_BAD_STYLESHEET_URL", "스타일시트 URL이 잘못됨: {0}" }, { "ER_FILE_NOT_FOUND", "스타일시트 파일을 찾을 수 없음: {0}" }, { "ER_IOEXCEPTION", "스타일시트 파일에 IO 예외사항 발생: {0}" }, { "ER_NO_HREF_ATTRIB", "(StylesheetHandler) {0}에 대한 href 속성을 찾을 수 없습니다." }, { "ER_STYLESHEET_INCLUDES_ITSELF", "(StylesheetHandler) {0}에 직접 또는 간접적으로 자신이 포함되어 있습니다!" }, 
        { "ER_PROCESSINCLUDE_ERROR", "StylesheetHandler.processInclude 오류, {0}" }, { "ER_MISSING_LANG_ATTRIB", "(StylesheetHandler) {0} 속성 ''lang''가 누락되었습니다." }, { "ER_MISSING_CONTAINER_ELEMENT_COMPONENT", "(StylesheetHandler) {0} 요소의 위치가 잘못된 것 같습니다. 컨테이너 요소 ''component''가 누락되었습니다." }, { "ER_CAN_ONLY_OUTPUT_TO_ELEMENT", "Element, DocumentFragment, Document 또는 PrintWriter에만 출력할 수 있습니다." }, { "ER_PROCESS_ERROR", "StylesheetRoot.process 오류" }, { "ER_UNIMPLNODE_ERROR", "UnImplNode 오류: {0}" }, { "ER_NO_SELECT_EXPRESSION", "오류: xpath select 표현식(-select)을 찾을 수 없습니다." }, { "ER_CANNOT_SERIALIZE_XSLPROCESSOR", "XSLProcessor를 직렬화할 수 없습니다!" }, { "ER_NO_INPUT_STYLESHEET", "스타일시트 입력값이 지정되지 않았습니다!" }, { "ER_FAILED_PROCESS_STYLESHEET", "스타일시트 처리를 실패했습니다!" }, 
        { "ER_COULDNT_PARSE_DOC", "{0} 문서의 구문을 분석할 수 없습니다!" }, { "ER_COULDNT_FIND_FRAGMENT", "부분을 찾을 수 없음: {0}" }, { "ER_NODE_NOT_ELEMENT", "부분 식별자가 가리킨 노드는 요소가 아님: {0}" }, { "ER_FOREACH_NEED_MATCH_OR_NAME_ATTRIB", "for-each에는 match 또는 name 속성이 있어야 합니다." }, { "ER_TEMPLATES_NEED_MATCH_OR_NAME_ATTRIB", "templates에는 match 또는 name 속성이 있어야 합니다." }, { "ER_NO_CLONE_OF_DOCUMENT_FRAG", "문서 부분의 복제본이 없습니다!" }, { "ER_CANT_CREATE_ITEM", "결과 트리에 항목을 생성할 수 없음: {0}" }, { "ER_XMLSPACE_ILLEGAL_VALUE", "소스 XML의 xml:space에 잘못된 값이 있음: {0}" }, { "ER_NO_XSLKEY_DECLARATION", "{0}에 대한 xsl:key 선언이 없습니다!" }, { "ER_CANT_CREATE_URL", "오류: {0}에 대한 URL을 생성할 수 없습니다." }, 
        { "ER_XSLFUNCTIONS_UNSUPPORTED", "xsl:functions는 지원되지 않습니다." }, { "ER_PROCESSOR_ERROR", "XSLT TransformerFactory 오류" }, { "ER_NOT_ALLOWED_INSIDE_STYLESHEET", "(StylesheetHandler) 스타일시트에서는 {0}이(가) 허용되지 않습니다!" }, { "ER_RESULTNS_NOT_SUPPORTED", "result-ns는 더 이상 지원되지 않습니다! 대신 xsl:output을 사용하십시오." }, { "ER_DEFAULTSPACE_NOT_SUPPORTED", "default-space는 더 이상 지원되지 않습니다! 대신 xsl:strip-space 또는 xsl:preserve-space를 사용하십시오." }, { "ER_INDENTRESULT_NOT_SUPPORTED", "indent-result는 더 이상 지원되지 않습니다! 대신 xsl:output을 사용하십시오." }, { "ER_ILLEGAL_ATTRIB", "(StylesheetHandler) {0}에 잘못된 속성이 있음: {1}" }, { "ER_UNKNOWN_XSL_ELEM", "알 수 없는 XSL 요소: {0}" }, { "ER_BAD_XSLSORT_USE", "(StylesheetHandler) xsl:sort는 xsl:apply-templates 또는 xsl:for-each와 함께만 사용할 수 있습니다." }, { "ER_MISPLACED_XSLWHEN", "(StylesheetHandler) xsl:when의 위치가 잘못되었습니다!" }, 
        { "ER_XSLWHEN_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:when이 xsl:choose에 의해 상위로 지정되지 않았습니다!" }, { "ER_MISPLACED_XSLOTHERWISE", "(StylesheetHandler) xsl:otherwise의 위치가 잘못되었습니다!" }, { "ER_XSLOTHERWISE_NOT_PARENTED_BY_XSLCHOOSE", "(StylesheetHandler) xsl:otherwise가 xsl:choose에 의해 상위로 지정되지 않았습니다!" }, { "ER_NOT_ALLOWED_INSIDE_TEMPLATE", "(StylesheetHandler) 템플리트에서는 {0}이(가) 허용되지 않습니다!" }, { "ER_UNKNOWN_EXT_NS_PREFIX", "(StylesheetHandler) {0} 확장 네임스페이스 접두어 {1}을(를) 알 수 없습니다." }, { "ER_IMPORTS_AS_FIRST_ELEM", "(StylesheetHandler) 스타일시트의 첫번째 요소로만 임포트를 수행할 수 있습니다!" }, { "ER_IMPORTING_ITSELF", "(StylesheetHandler) {0}이(가) 직접 또는 간접적으로 자신을 임포트하고 있습니다!" }, { "ER_XMLSPACE_ILLEGAL_VAL", "(StylesheetHandler) xml:space에 잘못된 값이 있음: {0}" }, { "ER_PROCESSSTYLESHEET_NOT_SUCCESSFUL", "processStylesheet를 실패했습니다!" }, { "ER_SAX_EXCEPTION", "SAX 예외사항" }, 
        { "ER_FUNCTION_NOT_SUPPORTED", "함수가 지원되지 않습니다!" }, { "ER_XSLT_ERROR", "XSLT 오류" }, { "ER_CURRENCY_SIGN_ILLEGAL", "형식 패턴 문자열에서는 통화 기호가 허용되지 않습니다." }, { "ER_DOCUMENT_FUNCTION_INVALID_IN_STYLESHEET_DOM", "Document 함수는 스타일시트 DOM에서 지원되지 않습니다!" }, { "ER_CANT_RESOLVE_PREFIX_OF_NON_PREFIX_RESOLVER", "비접두어 분석기의 접두어를 분석할 수 없습니다!" }, { "ER_REDIRECT_COULDNT_GET_FILENAME", "재지정 확장: 파일 이름을 가져올 수 없습니다. file 또는 select 속성은 적합한 문자열을 반환해야 합니다." }, { "ER_CANNOT_BUILD_FORMATTERLISTENER_IN_REDIRECT", "재지정 확장에 FormatterListener를 생성할 수 없습니다!" }, { "ER_INVALID_PREFIX_IN_EXCLUDERESULTPREFIX", "exclude-result-prefixes의 접두어가 부적합함: {0}" }, { "ER_MISSING_NS_URI", "지정된 접두어에 대한 네임스페이스 URI가 누락되었습니다." }, { "ER_MISSING_ARG_FOR_OPTION", "옵션에 대한 인수가 누락됨: {0}" }, 
        { "ER_INVALID_OPTION", "부적합한 옵션: {0}" }, { "ER_MALFORMED_FORMAT_STRING", "잘못된 형식 문자열: {0}" }, { "ER_STYLESHEET_REQUIRES_VERSION_ATTRIB", "xsl:stylesheet에는 'version' 속성이 필요합니다!" }, { "ER_ILLEGAL_ATTRIBUTE_VALUE", "{0} 속성에 잘못된 값이 있음: {1}" }, { "ER_CHOOSE_REQUIRES_WHEN", "xsl:choose에는 xsl:when이 필요합니다." }, { "ER_NO_APPLY_IMPORT_IN_FOR_EACH", "xsl:for-each에서는 xsl:apply-imports가 허용되지 않습니다." }, { "ER_CANT_USE_DTM_FOR_OUTPUT", "출력 DOM 노드에 DTMLiaison을 사용할 수 없습니다. 대신 com.sun.org.apache.xpath.internal.DOM2Helper를 전달하십시오!" }, { "ER_CANT_USE_DTM_FOR_INPUT", "입력 DOM 노드에 DTMLiaison을 사용할 수 없습니다. 대신 com.sun.org.apache.xpath.internal.DOM2Helper를 전달하십시오!" }, { "ER_CALL_TO_EXT_FAILED", "확장 요소에 대한 호출 실패: {0}" }, { "ER_PREFIX_MUST_RESOLVE", "접두어는 네임스페이스로 분석되어야 함: {0}" }, 
        { "ER_INVALID_UTF16_SURROGATE", "부적합한 UTF-16 대리 요소가 감지됨: {0}" }, { "ER_XSLATTRSET_USED_ITSELF", "xsl:attribute-set {0}이(가) 자신을 사용했습니다. 이 경우 무한 루프가 발생합니다." }, { "ER_CANNOT_MIX_XERCESDOM", "비Xerces-DOM 입력과 Xerces-DOM 출력을 함께 사용할 수 없습니다!" }, { "ER_TOO_MANY_LISTENERS", "addTraceListenersToStylesheet - TooManyListenersException" }, { "ER_IN_ELEMTEMPLATEELEM_READOBJECT", "ElemTemplateElement.readObject에 오류 발생: {0}" }, { "ER_DUPLICATE_NAMED_TEMPLATE", "명명된 템플리트를 두 개 이상 찾음: {0}" }, { "ER_INVALID_KEY_CALL", "부적합한 함수 호출: recursive key() 호출은 허용되지 않습니다." }, { "ER_REFERENCING_ITSELF", "{0} 변수가 직접 또는 간접적으로 자신을 참조하고 있습니다!" }, { "ER_ILLEGAL_DOMSOURCE_INPUT", "newTemplates의 DOMSource에 대한 입력 노드는 널일 수 없습니다!" }, { "ER_CLASS_NOT_FOUND_FOR_OPTION", "{0} 옵션에 대한 클래스 파일을 찾을 수 없습니다." }, 
        { "ER_REQUIRED_ELEM_NOT_FOUND", "필수 요소를 찾을 수 없음: {0}" }, { "ER_INPUT_CANNOT_BE_NULL", "InputStream은 널일 수 없습니다." }, { "ER_URI_CANNOT_BE_NULL", "URI는 널일 수 없습니다." }, { "ER_FILE_CANNOT_BE_NULL", "파일은 널일 수 없습니다." }, { "ER_SOURCE_CANNOT_BE_NULL", "InputSource는 널일 수 없습니다." }, { "ER_CANNOT_INIT_BSFMGR", "BSF 관리자를 초기화할 수 없습니다." }, { "ER_CANNOT_CMPL_EXTENSN", "확장을 컴파일할 수 없습니다." }, { "ER_CANNOT_CREATE_EXTENSN", "{0} 확장을 생성할 수 없는 원인: {1}" }, { "ER_INSTANCE_MTHD_CALL_REQUIRES", "{0} 메소드에 대한 인스턴스 메소드에는 객체 인스턴스가 첫번째 인수로 필요합니다." }, { "ER_INVALID_ELEMENT_NAME", "부적합한 요소 이름이 지정됨: {0}" }, 
        { "ER_ELEMENT_NAME_METHOD_STATIC", "요소 이름 메소드는 정적 {0}이어야 합니다." }, { "ER_EXTENSION_FUNC_UNKNOWN", "확장 함수 {0}: {1}을(를) 알 수 없습니다." }, { "ER_MORE_MATCH_CONSTRUCTOR", "{0}에 대한 생성자와 가장 잘 일치하는 항목이 두 개 이상 있습니다." }, { "ER_MORE_MATCH_METHOD", "{0} 메소드와 가장 잘 일치하는 항목이 두 개 이상 있습니다." }, { "ER_MORE_MATCH_ELEMENT", "요소 메소드 {0}과(와) 가장 잘 일치하는 항목이 두 개 이상 있습니다." }, { "ER_INVALID_CONTEXT_PASSED", "{0} 평가를 위해 부적합한 컨텍스트가 전달되었습니다." }, { "ER_POOL_EXISTS", "풀이 존재합니다." }, { "ER_NO_DRIVER_NAME", "지정된 드라이버 이름이 없습니다." }, { "ER_NO_URL", "지정된 URL이 없습니다." }, { "ER_POOL_SIZE_LESSTHAN_ONE", "풀 크기가 1보다 작습니다!" }, 
        { "ER_INVALID_DRIVER", "부적합한 드라이버 이름이 지정되었습니다!" }, { "ER_NO_STYLESHEETROOT", "스타일시트 루트를 찾을 수 없습니다!" }, { "ER_ILLEGAL_XMLSPACE_VALUE", "xml:space에 대한 값이 잘못되었습니다." }, { "ER_PROCESSFROMNODE_FAILED", "processFromNode를 실패했습니다." }, { "ER_RESOURCE_COULD_NOT_LOAD", "[{0}] 리소스가 다음을 로드할 수 없음: {1} \n {2} \t {3}" }, { "ER_BUFFER_SIZE_LESSTHAN_ZERO", "버퍼 크기 <=0" }, { "ER_UNKNOWN_ERROR_CALLING_EXTENSION", "확장을 호출하는 중 알 수 없는 오류가 발생했습니다." }, { "ER_NO_NAMESPACE_DECL", "{0} 접두어에 해당하는 네임스페이스 선언이 없습니다." }, { "ER_ELEM_CONTENT_NOT_ALLOWED", "lang=javaclass {0}에 대해서는 요소 콘텐츠가 허용되지 않습니다." }, { "ER_STYLESHEET_DIRECTED_TERMINATION", "스타일시트가 종료를 지정했습니다." }, 
        { "ER_ONE_OR_TWO", "1 또는 2" }, { "ER_TWO_OR_THREE", "2 또는 3" }, { "ER_COULD_NOT_LOAD_RESOURCE", "{0}을(를) 로드할 수 없습니다. CLASSPATH를 확인하십시오. 현재 기본값만 사용하는 중입니다." }, { "ER_CANNOT_INIT_DEFAULT_TEMPLATES", "기본 템플리트를 초기화할 수 없습니다." }, { "ER_RESULT_NULL", "결과는 널이 아니어야 합니다." }, { "ER_RESULT_COULD_NOT_BE_SET", "결과를 설정할 수 없습니다." }, { "ER_NO_OUTPUT_SPECIFIED", "지정된 출력이 없습니다." }, { "ER_CANNOT_TRANSFORM_TO_RESULT_TYPE", "{0} 유형의 결과로 변환할 수 없습니다." }, { "ER_CANNOT_TRANSFORM_SOURCE_TYPE", "{0} 유형의 소스를 변환할 수 없습니다." }, { "ER_NULL_CONTENT_HANDLER", "널 콘텐츠 처리기" }, 
        { "ER_NULL_ERROR_HANDLER", "널 오류 처리기" }, { "ER_CANNOT_CALL_PARSE", "ContentHandler가 설정되지 않은 경우 parse를 호출할 수 없습니다." }, { "ER_NO_PARENT_FOR_FILTER", "필터에 대한 상위가 없습니다." }, { "ER_NO_STYLESHEET_IN_MEDIA", "{0}에서 스타일시트를 찾을 수 없습니다. 매체 = {1}" }, { "ER_NO_STYLESHEET_PI", "{0}에서 xml-stylesheet PI를 찾을 수 없습니다." }, { "ER_NOT_SUPPORTED", "지원되지 않음: {0}" }, { "ER_PROPERTY_VALUE_BOOLEAN", "{0} 속성에 대한 값은 부울 인스턴스여야 합니다." }, { "ER_COULD_NOT_FIND_EXTERN_SCRIPT", "{0}에 있는 외부 스크립트로 가져올 수 없습니다." }, { "ER_RESOURCE_COULD_NOT_FIND", "[{0}] 리소스를 찾을 수 없습니다.\n {1}" }, { "ER_OUTPUT_PROPERTY_NOT_RECOGNIZED", "출력 속성을 인식할 수 없음: {0}" }, 
        { "ER_FAILED_CREATING_ELEMLITRSLT", "ElemLiteralResult 인스턴스 생성을 실패했습니다." }, { "ER_VALUE_SHOULD_BE_NUMBER", "{0}에 대한 값에는 구문을 분석할 수 있는 숫자가 포함되어야 합니다." }, { "ER_VALUE_SHOULD_EQUAL", "{0}에 대한 값은 yes 또는 no여야 합니다." }, { "ER_FAILED_CALLING_METHOD", "{0} 메소드 호출을 실패했습니다." }, { "ER_FAILED_CREATING_ELEMTMPL", "ElemTemplateElement 인스턴스 생성을 실패했습니다." }, { "ER_CHARS_NOT_ALLOWED", "문서의 이 지점에서는 문자가 허용되지 않습니다." }, { "ER_ATTR_NOT_ALLOWED", "{1} 요소에서는 \"{0}\" 속성이 허용되지 않습니다!" }, { "ER_BAD_VALUE", "{0}: 잘못된 값 {1} " }, { "ER_ATTRIB_VALUE_NOT_FOUND", "{0} 속성값을 찾을 수 없습니다. " }, { "ER_ATTRIB_VALUE_NOT_RECOGNIZED", "{0} 속성값을 인식할 수 없습니다. " }, 
        { "ER_NULL_URI_NAMESPACE", "널 URI를 사용하여 네임스페이스 접두어를 생성하려고 시도하는 중" }, { "ER_NUMBER_TOO_BIG", "가장 큰 Long 정수보다 큰 숫자의 형식을 지정하려고 시도하는 중" }, { "ER_CANNOT_FIND_SAX1_DRIVER", "SAX1 드라이버 클래스 {0}을(를) 찾을 수 없습니다." }, { "ER_SAX1_DRIVER_NOT_LOADED", "SAX1 드라이버 클래스 {0}이(가) 발견되었지만 해당 클래스를 로드할 수 없습니다." }, { "ER_SAX1_DRIVER_NOT_INSTANTIATED", "SAX1 드라이버 클래스 {0}이(가) 로드되었지만 해당 클래스를 인스턴스화할 수 없습니다." }, { "ER_SAX1_DRIVER_NOT_IMPLEMENT_PARSER", "SAX1 드라이버 클래스 {0}이(가) org.xml.sax.Parser를 구현하지 않았습니다." }, { "ER_PARSER_PROPERTY_NOT_SPECIFIED", "시스템 속성 org.xml.sax.parser가 지정되지 않았습니다." }, { "ER_PARSER_ARG_CANNOT_BE_NULL", "구문 분석기 인수는 널이 아니어야 합니다." }, { "ER_FEATURE", "기능: {0}" }, { "ER_PROPERTY", "속성: {0}" }, 
        { "ER_NULL_ENTITY_RESOLVER", "널 엔티티 분석기" }, { "ER_NULL_DTD_HANDLER", "널 DTD 처리기" }, { "ER_NO_DRIVER_NAME_SPECIFIED", "지정된 드라이버 이름이 없습니다!" }, { "ER_NO_URL_SPECIFIED", "지정된 URL이 없습니다!" }, { "ER_POOLSIZE_LESS_THAN_ONE", "풀 크기가 1 미만입니다!" }, { "ER_INVALID_DRIVER_NAME", "부적합한 드라이버 이름이 지정되었습니다!" }, { "ER_ERRORLISTENER", "ErrorListener" }, { "ER_ASSERT_NO_TEMPLATE_PARENT", "프로그래머 오류입니다! 표현식에 ElemTemplateElement 상위가 없습니다!" }, { "ER_ASSERT_REDUNDENT_EXPR_ELIMINATOR", "RedundentExprEliminator에 프로그래머 검증이 있음: {0}" }, { "ER_NOT_ALLOWED_IN_POSITION", "스타일시트의 이 위치에는 {0}이(가) 허용되지 않습니다!" }, 
        { "ER_NONWHITESPACE_NOT_ALLOWED_IN_POSITION", "스타일시트의 이 위치에는 공백이 아닌 텍스트는 허용되지 않습니다!" }, { "INVALID_TCHAR", "잘못된 값: {1}이(가) CHAR 속성에 사용됨: {0}. CHAR 유형의 속성은 1자여야 합니다!" }, { "INVALID_QNAME", "잘못된 값: {1}이(가) QNAME 속성에 사용됨: {0}" }, { "INVALID_ENUM", "잘못된 값: {1}이(가) ENUM 속성에 사용됨: {0}. 적합한 값: {2}." }, { "INVALID_NMTOKEN", "잘못된 값: {1}이(가) NMTOKEN 속성에 사용됨: {0} " }, { "INVALID_NCNAME", "잘못된 값: {1}이(가) NCNAME 속성에 사용됨: {0} " }, { "INVALID_BOOLEAN", "잘못된 값: {1}이(가) boolean 속성에 사용됨: {0} " }, { "INVALID_NUMBER", "잘못된 값: {1}이(가) number 속성에 사용됨: {0} " }, { "ER_ARG_LITERAL", "일치 패턴의 {0}에 대한 인수는 리터럴이어야 합니다." }, { "ER_DUPLICATE_GLOBAL_VAR", "전역 변수 선언이 중복됩니다." }, 
        { "ER_DUPLICATE_VAR", "변수 선언이 중복됩니다." }, { "ER_TEMPLATE_NAME_MATCH", "xsl:template에는 name 또는 match 속성 중 하나가 있거나 모두 있어야 합니다." }, { "ER_INVALID_PREFIX", "exclude-result-prefixes의 접두어가 부적합함: {0}" }, { "ER_NO_ATTRIB_SET", "이름이 {0}인 attribute-set가 존재하지 않습니다." }, { "ER_FUNCTION_NOT_FOUND", "이름이 {0}인 함수가 존재하지 않습니다." }, { "ER_CANT_HAVE_CONTENT_AND_SELECT", "{0} 요소에는 content 속성과 select 속성이 함께 포함되지 않아야 합니다." }, { "ER_INVALID_SET_PARAM_VALUE", "{0} 매개변수의 값은 적합한 Java 객체여야 합니다." }, { "ER_INVALID_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX_FOR_DEFAULT", "xsl:namespace-alias 요소의 result-prefix 속성에 대한 값은 '#default'이지만 요소에 대한 범위에서 기본 네임스페이스가 선언되지 않았습니다." }, { "ER_INVALID_SET_NAMESPACE_URI_VALUE_FOR_RESULT_PREFIX", "xsl:namespace-alias 요소의 result-prefix 속성에 대한 값은 ''{0}''이지만 요소에 대한 범위에서 ''{0}'' 접두어의 네임스페이스가 선언되지 않았습니다." }, { "ER_SET_FEATURE_NULL_NAME", "기능 이름은 TransformerFactory.setFeature(문자열 이름, 부울 값)에서 널일 수 없습니다." }, 
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\org\apache\xalan\internal\res\XSLTErrorResources_ko.class
