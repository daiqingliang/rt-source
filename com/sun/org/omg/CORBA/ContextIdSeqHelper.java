...
public final class ContextIdSeqHelper {
  ...
  public static String[] read(InputStream paramInputStream) {
    ...
    for (byte b = 0; b < arrayOfString.length; b++)
      arrayOfString[b] = ContextIdentifierHelper.read(paramInputStream); 
  ...
  public static void write(OutputStream paramOutputStream, String[] paramArrayOfString) {
    ...
    for (byte b = 0; b < paramArrayOfString.length; b++)
      ContextIdentifierHelper.write(paramOutputStream, paramArrayOfString[b]); 
  }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\org\omg\CORBA\ContextIdSeqHelper.class
