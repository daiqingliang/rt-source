  ...
  public void text(UnmarshallingContext.State paramState, CharSequence paramCharSequence) throws SAXException {
    try {
      ...
      if (paramState.getPrev() != null) {
        if (!(paramState.getPrev().getTarget() instanceof javax.xml.bind.JAXBElement))
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\xml\internal\bind\v2\runtim\\unmarshaller\ValuePropertyLoader.class
