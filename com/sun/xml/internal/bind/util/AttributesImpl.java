...
public class AttributesImpl implements Attributes {
  ...
  public int getIndexFast(String paramString1, String paramString2) {
    for (int i = (this.length - 1) * 5; i >= 0; i -= 5) {
      if (this.data[i + true] == paramString2 && this.data[i] == paramString1)
        return i / 5; 
    } 
    return -1;
  }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\xml\internal\bin\\util\AttributesImpl.class
