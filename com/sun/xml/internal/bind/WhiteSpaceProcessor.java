...
public abstract class WhiteSpaceProcessor {
  ...
  public static boolean isWhiteSpace(char paramChar) { return (paramChar > ' ') ? false : ((paramChar == '\t' || paramChar == '\n' || paramChar == '\r' || paramChar == ' ')); }
  
  protected static boolean isWhiteSpaceExceptSpace(char paramChar) { return (paramChar >= ' ') ? false : ((paramChar == '\t' || paramChar == '\n' || paramChar == '\r')); }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\xml\internal\bind\WhiteSpaceProcessor.class
