...
public class SystemIdResolver {
  public static String getAbsoluteURIFromRelative(String paramString) {
    ...
    if (null != str1) {
      str2 = str1.startsWith(File.separator) ? ("file://" + str1) : ("file:///" + str1);
    } else {
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\xml\internal\fastinfoset\sax\SystemIdResolver.class
