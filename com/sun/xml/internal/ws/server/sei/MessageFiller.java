...
public abstract class MessageFiller {
  ...
  private static class ByteArrayFiller extends AttachmentFiller {
    ...
    public void fillIn(Object[] param1ArrayOfObject, Object param1Object, Message param1Message) {
      String str = getContentId();
      Object object = (this.methodPos == -1) ? param1Object : this.getter.get(param1ArrayOfObject[this.methodPos]);
      if (object != null) {
  ...
  public static final class Header extends MessageFiller {
    ...
    public Header(int param1Int, XMLBridge param1XMLBridge, ValueGetter param1ValueGetter) {
      super(param1Int);
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\xml\internal\ws\server\sei\MessageFiller.class
