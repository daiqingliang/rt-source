...
public abstract class ServerAlreadyRegisteredHelper {
  ...
  public static void insert(Any paramAny, ServerAlreadyRegistered paramServerAlreadyRegistered) {
    ...
    paramAny.type(type());
    write(outputStream, paramServerAlreadyRegistered);
    paramAny.read_value(outputStream.create_input_stream(), type());
  }
  
  public static ServerAlreadyRegistered extract(Any paramAny) { return read(paramAny.create_input_stream()); }
  ...
  public static ServerAlreadyRegistered read(InputStream paramInputStream) {
    ...
    serverAlreadyRegistered.serverId = paramInputStream.read_long();
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\corba\se\spi\activation\ServerAlreadyRegisteredHelper.class
