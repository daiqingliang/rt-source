...
class ObjectStreamField implements Comparable {
  ...
  ObjectStreamField(String paramString, Class paramClass) {
    ...
    if (paramClass.isPrimitive()) {
      ...
      this.type = '[';
      this.typeString = ObjectStreamClass_1_3_1.getSignature(paramClass);
    } else {
      this.type = 'L';
      this.typeString = ObjectStreamClass_1_3_1.getSignature(paramClass);
    } 
  ...
  public boolean typeEquals(ObjectStreamField paramObjectStreamField) { return (paramObjectStreamField == null || this.type != paramObjectStreamField.type) ? false : ((this.typeString == null && paramObjectStreamField.typeString == null) ? true : ObjectStreamClass_1_3_1.compareClassNames(this.typeString, paramObjectStreamField.typeString, '/')); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\corba\se\impl\orbutil\ObjectStreamField.class
