...
public class MotifMenuItemUI extends BasicMenuItemUI {
  ...
  public static ComponentUI createUI(JComponent paramJComponent) { return new MotifMenuItemUI(); }
  ...
  protected class ChangeHandler implements ChangeListener {
    public void stateChanged(ChangeEvent param1ChangeEvent) {
      ...
      LookAndFeel.installProperty(jMenuItem, "borderPainted", Boolean.valueOf((jMenuItem.isArmed() || jMenuItem.isSelected())));
    }
  }
  ...
  protected class MouseInputHandler implements MouseInputListener {
    ...
    public void mousePressed(MouseEvent param1MouseEvent) {
      ...
      menuSelectionManager.setSelectedPath(MotifMenuItemUI.this.getPath());
    }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\com\sun\java\swing\plaf\motif\MotifMenuItemUI.class
