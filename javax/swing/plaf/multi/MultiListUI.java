...
public class MultiListUI extends ListUI {
  ...
  public int locationToIndex(JList paramJList, Point paramPoint) {
    int i = ((ListUI)this.uis.elementAt(0)).locationToIndex(paramJList, paramPoint);
    for (byte b = 1; b < this.uis.size(); b++)
      ((ListUI)this.uis.elementAt(b)).locationToIndex(paramJList, paramPoint); 
    return i;
  }
  
  public Point indexToLocation(JList paramJList, int paramInt) {
    Point point = ((ListUI)this.uis.elementAt(0)).indexToLocation(paramJList, paramInt);
    for (byte b = 1; b < this.uis.size(); b++)
      ((ListUI)this.uis.elementAt(b)).indexToLocation(paramJList, paramInt); 
    return point;
  }
  
  public Rectangle getCellBounds(JList paramJList, int paramInt1, int paramInt2) {
    Rectangle rectangle = ((ListUI)this.uis.elementAt(0)).getCellBounds(paramJList, paramInt1, paramInt2);
    for (byte b = 1; b < this.uis.size(); b++)
      ((ListUI)this.uis.elementAt(b)).getCellBounds(paramJList, paramInt1, paramInt2); 
    return rectangle;
  }
  ...
  public static ComponentUI createUI(JComponent paramJComponent) {
    ...
    return MultiLookAndFeel.createUIs(multiListUI, ((MultiListUI)multiListUI).uis, paramJComponent);
  }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\javax\swing\plaf\multi\MultiListUI.class
