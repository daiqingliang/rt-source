...
public class MultiOptionPaneUI extends OptionPaneUI {
  ...
  public void selectInitialValue(JOptionPane paramJOptionPane) {
    for (byte b = 0; b < this.uis.size(); b++)
      ((OptionPaneUI)this.uis.elementAt(b)).selectInitialValue(paramJOptionPane); 
  }
  ...
  public boolean containsCustomComponents(JOptionPane paramJOptionPane) {
    ...
    for (byte b = 1; b < this.uis.size(); b++)
      ((OptionPaneUI)this.uis.elementAt(b)).containsCustomComponents(paramJOptionPane); 
    return bool;
  }
  ...
  public static ComponentUI createUI(JComponent paramJComponent) {
    ...
    return MultiLookAndFeel.createUIs(multiOptionPaneUI, ((MultiOptionPaneUI)multiOptionPaneUI).uis, paramJComponent);
  }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\javax\swing\plaf\multi\MultiOptionPaneUI.class
