...
public class MultiComboBoxUI extends ComboBoxUI {
  ...
  public boolean isFocusTraversable(JComboBox paramJComboBox) {
    ...
    for (byte b = 1; b < this.uis.size(); b++)
      ((ComboBoxUI)this.uis.elementAt(b)).isFocusTraversable(paramJComboBox); 
    return bool;
  }
  
  public void setPopupVisible(JComboBox paramJComboBox, boolean paramBoolean) {
    for (byte b = 0; b < this.uis.size(); b++)
      ((ComboBoxUI)this.uis.elementAt(b)).setPopupVisible(paramJComboBox, paramBoolean); 
  }
  ...
  public boolean isPopupVisible(JComboBox paramJComboBox) {
    ...
    for (byte b = 1; b < this.uis.size(); b++)
      ((ComboBoxUI)this.uis.elementAt(b)).isPopupVisible(paramJComboBox); 
    return bool;
  }
  ...
  public static ComponentUI createUI(JComponent paramJComponent) {
    ...
    return MultiLookAndFeel.createUIs(multiComboBoxUI, ((MultiComboBoxUI)multiComboBoxUI).uis, paramJComponent);
  }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\javax\swing\plaf\multi\MultiComboBoxUI.class
