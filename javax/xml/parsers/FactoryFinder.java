...
class FactoryFinder {
  ...
  static <T> T newInstance(Class<T> paramClass, String paramString, ClassLoader paramClassLoader, boolean paramBoolean1, boolean paramBoolean2) throws FactoryConfigurationError {
    ...
    try {
      ...
      throw new FactoryConfigurationError(classNotFoundException, "Provider " + paramString + " not found");
    } catch (Exception exception) {
      throw new FactoryConfigurationError(exception, "Provider " + paramString + " could not be instantiated: " + exception);
    } 
  }
  
  static <T> T find(Class<T> paramClass, String paramString) throws FactoryConfigurationError {
    ...
    if (object != null)
      return (T)object; 
    if (paramString == null)
      throw new FactoryConfigurationError("Provider for " + str + " cannot be found"); 
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\javax\xml\parsers\FactoryFinder.class
