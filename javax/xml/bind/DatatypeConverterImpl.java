...
final class DatatypeConverterImpl implements DatatypeConverterInterface {
  ...
  public Calendar parseTime(String paramString) { return datatypeFactory.newXMLGregorianCalendar(paramString).toGregorianCalendar(); }
  
  public String printTime(Calendar paramCalendar) { return CalendarFormatter.doFormat("%h:%m:%s%z", paramCalendar); }
  
  public Calendar parseDate(String paramString) { return datatypeFactory.newXMLGregorianCalendar(paramString).toGregorianCalendar(); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\javax\xml\bind\DatatypeConverterImpl.class
