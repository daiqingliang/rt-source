...
class ByteBufferAsFloatBufferB extends FloatBuffer {
  ...
  public FloatBuffer duplicate() { return new ByteBufferAsFloatBufferB(this.bb, markValue(), position(), limit(), capacity(), this.offset); }
  
  public FloatBuffer asReadOnlyBuffer() { return new ByteBufferAsFloatBufferRB(this.bb, markValue(), position(), limit(), capacity(), this.offset); }
  
  protected int ix(int paramInt) { return (paramInt << 2) + this.offset; }
  
  public float get() { return Bits.getFloatB(this.bb, ix(nextGetIndex())); }
  
  public float get(int paramInt) { return Bits.getFloatB(this.bb, ix(checkIndex(paramInt))); }
