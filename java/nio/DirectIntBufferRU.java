...
class DirectIntBufferRU extends DirectIntBufferU implements DirectBuffer {
  DirectIntBufferRU(DirectBuffer paramDirectBuffer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) { super(paramDirectBuffer, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5); }
  ...
  public IntBuffer duplicate() { return new DirectIntBufferRU(this, markValue(), position(), limit(), capacity(), 0); }
