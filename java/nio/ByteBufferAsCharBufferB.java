...
class ByteBufferAsCharBufferB extends CharBuffer {
  ...
  public CharBuffer duplicate() { return new ByteBufferAsCharBufferB(this.bb, markValue(), position(), limit(), capacity(), this.offset); }
  
  public CharBuffer asReadOnlyBuffer() { return new ByteBufferAsCharBufferRB(this.bb, markValue(), position(), limit(), capacity(), this.offset); }
  
  protected int ix(int paramInt) { return (paramInt << 1) + this.offset; }
  
  public char get() { return Bits.getCharB(this.bb, ix(nextGetIndex())); }
  
  public char get(int paramInt) { return Bits.getCharB(this.bb, ix(checkIndex(paramInt))); }
  
  char getUnchecked(int paramInt) { return Bits.getCharB(this.bb, ix(paramInt)); }
  ...
  public CharBuffer subSequence(int paramInt1, int paramInt2) {
    ...
    if (paramInt1 < 0 || paramInt2 > k || paramInt1 > paramInt2)
      throw new IndexOutOfBoundsException(); 
    return new ByteBufferAsCharBufferB(this.bb, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
  }
