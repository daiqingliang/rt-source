...
class DirectCharBufferRS extends DirectCharBufferS implements DirectBuffer {
  DirectCharBufferRS(DirectBuffer paramDirectBuffer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) { super(paramDirectBuffer, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5); }
  ...
  public CharBuffer duplicate() { return new DirectCharBufferRS(this, markValue(), position(), limit(), capacity(), 0); }
  ...
  public CharBuffer subSequence(int paramInt1, int paramInt2) {
    ...
    if (paramInt1 < 0 || paramInt2 > k || paramInt1 > paramInt2)
      throw new IndexOutOfBoundsException(); 
    return new DirectCharBufferRS(this, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
  }
