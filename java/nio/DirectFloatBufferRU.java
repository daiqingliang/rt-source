...
class DirectFloatBufferRU extends DirectFloatBufferU implements DirectBuffer {
  DirectFloatBufferRU(DirectBuffer paramDirectBuffer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) { super(paramDirectBuffer, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5); }
  ...
  public FloatBuffer duplicate() { return new DirectFloatBufferRU(this, markValue(), position(), limit(), capacity(), 0); }
