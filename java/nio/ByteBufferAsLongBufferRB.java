...
class ByteBufferAsLongBufferRB extends ByteBufferAsLongBufferB {
  ByteBufferAsLongBufferRB(ByteBuffer paramByteBuffer) { super(paramByteBuffer); }
  
  ByteBufferAsLongBufferRB(ByteBuffer paramByteBuffer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) { super(paramByteBuffer, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5); }
  ...
  public LongBuffer duplicate() { return new ByteBufferAsLongBufferRB(this.bb, markValue(), position(), limit(), capacity(), this.offset); }
