...
class HeapByteBufferR extends HeapByteBuffer {
  HeapByteBufferR(int paramInt1, int paramInt2) { super(paramInt1, paramInt2); }
  
  HeapByteBufferR(byte[] paramArrayOfByte, int paramInt1, int paramInt2) { super(paramArrayOfByte, paramInt1, paramInt2); }
  
  protected HeapByteBufferR(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) { super(paramArrayOfByte, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5); }
  
  public ByteBuffer slice() { return new HeapByteBufferR(this.hb, -1, 0, remaining(), remaining(), position() + this.offset); }
  
  public ByteBuffer duplicate() { return new HeapByteBufferR(this.hb, markValue(), position(), limit(), capacity(), this.offset); }
