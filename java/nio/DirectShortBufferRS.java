...
class DirectShortBufferRS extends DirectShortBufferS implements DirectBuffer {
  DirectShortBufferRS(DirectBuffer paramDirectBuffer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) { super(paramDirectBuffer, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5); }
  ...
  public ShortBuffer duplicate() { return new DirectShortBufferRS(this, markValue(), position(), limit(), capacity(), 0); }
