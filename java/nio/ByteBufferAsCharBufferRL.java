...
class ByteBufferAsCharBufferRL extends ByteBufferAsCharBufferL {
  ByteBufferAsCharBufferRL(ByteBuffer paramByteBuffer) { super(paramByteBuffer); }
  
  ByteBufferAsCharBufferRL(ByteBuffer paramByteBuffer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) { super(paramByteBuffer, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5); }
  ...
  public CharBuffer duplicate() { return new ByteBufferAsCharBufferRL(this.bb, markValue(), position(), limit(), capacity(), this.offset); }
  ...
  public CharBuffer subSequence(int paramInt1, int paramInt2) {
    ...
    if (paramInt1 < 0 || paramInt2 > k || paramInt1 > paramInt2)
      throw new IndexOutOfBoundsException(); 
    return new ByteBufferAsCharBufferRL(this.bb, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
  }
