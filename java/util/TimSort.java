...
class TimSort<T> extends Object {
  ...
  static <T> void sort(T[] paramArrayOfT1, int paramInt1, int paramInt2, Comparator<? super T> paramComparator, T[] paramArrayOfT2, int paramInt3, int paramInt4) {
    ...
    TimSort timSort;
    int j = (timSort = new TimSort(paramArrayOfT1, paramComparator, paramArrayOfT2, paramInt3, paramInt4)).minRunLength(i);
    do {
      int k = countRunAndMakeAscending(paramArrayOfT1, paramInt1, paramInt2, paramComparator);
      if (k < j) {
        int m = (i <= j) ? i : j;
  ...
  private void mergeLo(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        if (comparator.compare(arrayOfObject1[j], arrayOfObject2[i]) < 0) {
          arrayOfObject1[k++] = arrayOfObject1[j++];
          i1++;
          n = 0;
          if (--paramInt4 == 0)
        ...
        if ((n | i1) >= m) {
          label79: while (true) {
            assert paramInt2 > 1 && paramInt4 > 0;
            n = gallopRight(arrayOfObject1[j], arrayOfObject2, i, paramInt2, 0, comparator);
            if (n != 0) {
            ...
            if (--paramInt4 == 0)
              break; 
            i1 = gallopLeft(arrayOfObject2[i], arrayOfObject1, j, paramInt4, 0, comparator);
            if (i1 != 0) {
  ...
  private void mergeHi(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        if (comparator.compare(arrayOfObject2[k], arrayOfObject1[j]) < 0) {
          arrayOfObject1[m--] = arrayOfObject1[j--];
          i1++;
          i2 = 0;
          if (--paramInt2 == 0)
        ...
        if ((i1 | i2) >= n) {
          label79: while (true) {
            assert paramInt2 > 0 && paramInt4 > 1;
            i1 = paramInt2 - gallopRight(arrayOfObject2[k], arrayOfObject1, paramInt1, paramInt2, paramInt2 - 1, comparator);
            if (i1 != 0) {
              m -= i1;
              j -= i1;
              paramInt2 -= i1;
            ...
            if (--paramInt4 == 1)
              break; 
            i2 = paramInt4 - gallopLeft(arrayOfObject1[j], arrayOfObject2, i, paramInt4, paramInt4 - 1, comparator);
            if (i2 != 0) {
              m -= i2;
              k -= i2;
              paramInt4 -= i2;
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\jav\\util\TimSort.class
