...
public abstract class ServantAlreadyActiveHelper {
  ...
  public static void insert(Any paramAny, ServantAlreadyActive paramServantAlreadyActive) {
    ...
    paramAny.type(type());
    write(outputStream, paramServantAlreadyActive);
    paramAny.read_value(outputStream.create_input_stream(), type());
  }
  
  public static ServantAlreadyActive extract(Any paramAny) { return read(paramAny.create_input_stream()); }
  ...
  public static void write(OutputStream paramOutputStream, ServantAlreadyActive paramServantAlreadyActive) { paramOutputStream.write_string(id()); }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\org\omg\PortableServer\POAPackage\ServantAlreadyActiveHelper.class
