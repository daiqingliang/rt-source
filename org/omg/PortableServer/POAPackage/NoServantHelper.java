...
public abstract class NoServantHelper {
  ...
  public static void insert(Any paramAny, NoServant paramNoServant) {
    ...
    paramAny.type(type());
    write(outputStream, paramNoServant);
    paramAny.read_value(outputStream.create_input_stream(), type());
  }
  
  public static NoServant extract(Any paramAny) { return read(paramAny.create_input_stream()); }
  ...
  public static void write(OutputStream paramOutputStream, NoServant paramNoServant) { paramOutputStream.write_string(id()); }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\org\omg\PortableServer\POAPackage\NoServantHelper.class
