...
public abstract class BindingListHelper {
  ...
  public static void insert(Any paramAny, Binding[] paramArrayOfBinding) {
    ...
    paramAny.type(type());
    write(outputStream, paramArrayOfBinding);
  ...
  public static Binding[] read(InputStream paramInputStream) {
    ...
    for (byte b = 0; b < arrayOfBinding.length; b++)
      arrayOfBinding[b] = BindingHelper.read(paramInputStream); 
  ...
  public static void write(OutputStream paramOutputStream, Binding[] paramArrayOfBinding) {
    ...
    for (byte b = 0; b < paramArrayOfBinding.length; b++)
      BindingHelper.write(paramOutputStream, paramArrayOfBinding[b]); 
  }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\org\omg\CosNaming\BindingListHelper.class
