...
public abstract class InvalidAddressHelper {
  ...
  public static void insert(Any paramAny, InvalidAddress paramInvalidAddress) {
    ...
    paramAny.type(type());
    write(outputStream, paramInvalidAddress);
    paramAny.read_value(outputStream.create_input_stream(), type());
  }
  
  public static InvalidAddress extract(Any paramAny) { return read(paramAny.create_input_stream()); }
  ...
  public static void write(OutputStream paramOutputStream, InvalidAddress paramInvalidAddress) { paramOutputStream.write_string(id()); }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\org\omg\CosNaming\NamingContextExtPackage\InvalidAddressHelper.class
