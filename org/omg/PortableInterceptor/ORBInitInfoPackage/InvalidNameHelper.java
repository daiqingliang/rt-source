...
public abstract class InvalidNameHelper {
  ...
  public static void insert(Any paramAny, InvalidName paramInvalidName) {
    ...
    paramAny.type(type());
    write(outputStream, paramInvalidName);
    paramAny.read_value(outputStream.create_input_stream(), type());
  }
  
  public static InvalidName extract(Any paramAny) { return read(paramAny.create_input_stream()); }
  ...
  public static void write(OutputStream paramOutputStream, InvalidName paramInvalidName) { paramOutputStream.write_string(id()); }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\org\omg\PortableInterceptor\ORBInitInfoPackage\InvalidNameHelper.class
