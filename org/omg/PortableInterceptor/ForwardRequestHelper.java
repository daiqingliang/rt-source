...
public abstract class ForwardRequestHelper {
    ...
    if (__typeCode == null)
      synchronized (TypeCode.class) {
        if (__typeCode == null) {
          ...
          arrayOfStructMember[0] = new StructMember("forward", typeCode, null);
  ...
  public static ForwardRequest read(InputStream paramInputStream) {
    ...
    forwardRequest.forward = ObjectHelper.read(paramInputStream);
  ...
  public static void write(OutputStream paramOutputStream, ForwardRequest paramForwardRequest) {
    ...
    ObjectHelper.write(paramOutputStream, paramForwardRequest.forward);
  }
}


/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\org\omg\PortableInterceptor\ForwardRequestHelper.class
