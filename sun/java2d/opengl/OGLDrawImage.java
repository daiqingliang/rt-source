...
public class OGLDrawImage extends DrawImage {
  protected void renderImageXform(SunGraphics2D paramSunGraphics2D, Image paramImage, AffineTransform paramAffineTransform, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, Color paramColor) {
    if (paramInt1 != 3) {
      ...
      if (surfaceData2 != null && !isBgOperation(surfaceData2, paramColor) && (surfaceData2.getSurfaceType() == OGLSurfaceData.OpenGLTexture || surfaceData2.getSurfaceType() == OGLSurfaceData.OpenGLSurfaceRTT || paramInt1 == 1)) {
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\java2d\opengl\OGLDrawImage.class
