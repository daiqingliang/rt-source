...
class UnsafeQualifiedStaticCharacterFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
  UnsafeQualifiedStaticCharacterFieldAccessorImpl(Field paramField, boolean paramBoolean) { super(paramField, paramBoolean); }
  ...
  public char getChar(Object paramObject) throws IllegalArgumentException { return unsafe.getCharVolatile(this.base, this.fieldOffset); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\reflect\UnsafeQualifiedStaticCharacterFieldAccessorImpl.class
