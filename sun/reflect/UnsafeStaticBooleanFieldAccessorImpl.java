...
class UnsafeStaticBooleanFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl {
  UnsafeStaticBooleanFieldAccessorImpl(Field paramField) { super(paramField); }
  
  public Object get(Object paramObject) throws IllegalArgumentException { return new Boolean(getBoolean(paramObject)); }
  
  public boolean getBoolean(Object paramObject) throws IllegalArgumentException { return unsafe.getBoolean(this.base, this.fieldOffset); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\reflect\UnsafeStaticBooleanFieldAccessorImpl.class
