...
class UnsafeQualifiedStaticIntegerFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
  UnsafeQualifiedStaticIntegerFieldAccessorImpl(Field paramField, boolean paramBoolean) { super(paramField, paramBoolean); }
  ...
  public int getInt(Object paramObject) throws IllegalArgumentException { return unsafe.getIntVolatile(this.base, this.fieldOffset); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\reflect\UnsafeQualifiedStaticIntegerFieldAccessorImpl.class
