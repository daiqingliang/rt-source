...
class UnsafeQualifiedStaticShortFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
  UnsafeQualifiedStaticShortFieldAccessorImpl(Field paramField, boolean paramBoolean) { super(paramField, paramBoolean); }
  ...
  public short getShort(Object paramObject) throws IllegalArgumentException { return unsafe.getShortVolatile(this.base, this.fieldOffset); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\reflect\UnsafeQualifiedStaticShortFieldAccessorImpl.class
