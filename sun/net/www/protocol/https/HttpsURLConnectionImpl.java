...
public class HttpsURLConnectionImpl extends HttpsURLConnection {
  ...
  HttpsURLConnectionImpl(URL paramURL, Handler paramHandler) throws IOException { this(paramURL, null, paramHandler); }
  ...
  protected HttpsURLConnectionImpl(URL paramURL) throws IOException { super(paramURL); }
  ...
  public Principal getPeerPrincipal() throws SSLPeerUnverifiedException { return this.delegate.getPeerPrincipal(); }
  
  public Principal getLocalPrincipal() throws SSLPeerUnverifiedException { return this.delegate.getLocalPrincipal(); }
