...
public class ISO_8859_9 extends Charset implements HistoricallyNamedCharset {
  ...
  public ISO_8859_9() { super("ISO-8859-9", StandardCharsets.aliases_ISO_8859_9); }
  
  public String historicalName() { return "ISO8859_9"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof ISO_8859_9); }
