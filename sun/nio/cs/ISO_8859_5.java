...
public class ISO_8859_5 extends Charset implements HistoricallyNamedCharset {
  ...
  public ISO_8859_5() { super("ISO-8859-5", StandardCharsets.aliases_ISO_8859_5); }
  
  public String historicalName() { return "ISO8859_5"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof ISO_8859_5); }
