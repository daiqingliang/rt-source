...
public class KOI8_U extends Charset implements HistoricallyNamedCharset {
  ...
  public KOI8_U() { super("KOI8-U", StandardCharsets.aliases_KOI8_U); }
  
  public String historicalName() { return "KOI8_U"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof KOI8_U); }
