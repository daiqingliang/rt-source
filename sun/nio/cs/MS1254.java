...
public class MS1254 extends Charset implements HistoricallyNamedCharset {
  ...
  public MS1254() { super("windows-1254", StandardCharsets.aliases_MS1254); }
  
  public String historicalName() { return "Cp1254"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof MS1254); }
