...
public class ISO_8859_2 extends Charset implements HistoricallyNamedCharset {
  ...
  public ISO_8859_2() { super("ISO-8859-2", StandardCharsets.aliases_ISO_8859_2); }
  
  public String historicalName() { return "ISO8859_2"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof ISO_8859_2); }
