...
public class MS1257 extends Charset implements HistoricallyNamedCharset {
  ...
  public MS1257() { super("windows-1257", StandardCharsets.aliases_MS1257); }
  
  public String historicalName() { return "Cp1257"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof MS1257); }
