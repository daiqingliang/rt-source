...
public class ISO_8859_7 extends Charset implements HistoricallyNamedCharset {
  ...
  public ISO_8859_7() { super("ISO-8859-7", StandardCharsets.aliases_ISO_8859_7); }
  
  public String historicalName() { return "ISO8859_7"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof ISO_8859_7); }
