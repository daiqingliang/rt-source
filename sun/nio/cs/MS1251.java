...
public class MS1251 extends Charset implements HistoricallyNamedCharset {
  ...
  public MS1251() { super("windows-1251", StandardCharsets.aliases_MS1251); }
  
  public String historicalName() { return "Cp1251"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof MS1251); }
