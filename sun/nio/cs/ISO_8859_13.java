...
public class ISO_8859_13 extends Charset implements HistoricallyNamedCharset {
  ...
  public ISO_8859_13() { super("ISO-8859-13", StandardCharsets.aliases_ISO_8859_13); }
  
  public String historicalName() { return "ISO8859_13"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof ISO_8859_13); }
