...
public class ISO_8859_4 extends Charset implements HistoricallyNamedCharset {
  ...
  public ISO_8859_4() { super("ISO-8859-4", StandardCharsets.aliases_ISO_8859_4); }
  
  public String historicalName() { return "ISO8859_4"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof ISO_8859_4); }
