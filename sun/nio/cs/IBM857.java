...
public class IBM857 extends Charset implements HistoricallyNamedCharset {
  ...
  public IBM857() { super("IBM857", StandardCharsets.aliases_IBM857); }
  
  public String historicalName() { return "Cp857"; }
  
  public boolean contains(Charset paramCharset) { return paramCharset instanceof IBM857; }
