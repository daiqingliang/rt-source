...
public class MS1253 extends Charset implements HistoricallyNamedCharset {
  ...
  public MS1253() { super("windows-1253", StandardCharsets.aliases_MS1253); }
  
  public String historicalName() { return "Cp1253"; }
  
  public boolean contains(Charset paramCharset) { return (paramCharset.name().equals("US-ASCII") || paramCharset instanceof MS1253); }
