...
public class JvmRTBootClassPathTableMetaImpl extends JvmRTBootClassPathTableMeta {
  ...
  public JvmRTBootClassPathTableMetaImpl(SnmpMib paramSnmpMib, SnmpStandardObjectServer paramSnmpStandardObjectServer) { super(paramSnmpMib, paramSnmpStandardObjectServer); }
  ...
  public Object getEntry(SnmpOid paramSnmpOid) throws SnmpStatusException {
    ...
    String str = (map == null) ? null : ("JvmRTBootClassPathTable.entry." + paramSnmpOid.toString());
    if (map != null) {
    ...
    JvmRTBootClassPathEntryImpl jvmRTBootClassPathEntryImpl = new JvmRTBootClassPathEntryImpl((String)object, (int)paramSnmpOid.getOidArc(0));
    if (map != null && jvmRTBootClassPathEntryImpl != null)
      map.put(str, jvmRTBootClassPathEntryImpl); 
    return jvmRTBootClassPathEntryImpl;
  }
  ...
  protected SnmpTableHandler getHandler(Object paramObject) {
    ...
    if (object != null) {
      SnmpTableHandler snmpTableHandler1 = (SnmpTableHandler)object.get("JvmRTBootClassPathTable.handler");
    ...
    if (object != null && snmpTableHandler != null)
      object.put("JvmRTBootClassPathTable.handler", snmpTableHandler); 
  ...
  private static class JvmRTBootClassPathTableCache extends SnmpTableCache {
    ...
    JvmRTBootClassPathTableCache(JvmRTBootClassPathTableMetaImpl param1JvmRTBootClassPathTableMetaImpl, long param1Long) {
      this.meta = param1JvmRTBootClassPathTableMetaImpl;
    ...
    protected SnmpCachedData updateCachedDatas(Object param1Object) {
      String[] arrayOfString = JvmRuntimeImpl.getBootClassPath(param1Object);
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\management\snmp\jvminstr\JvmRTBootClassPathTableMetaImpl.class
