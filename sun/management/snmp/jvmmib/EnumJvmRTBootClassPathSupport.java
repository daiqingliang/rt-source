...
public class EnumJvmRTBootClassPathSupport extends Enumerated implements Serializable {
  ...
  public EnumJvmRTBootClassPathSupport(int paramInt) throws IllegalArgumentException { super(paramInt); }
  
  public EnumJvmRTBootClassPathSupport(Integer paramInteger) throws IllegalArgumentException { super(paramInteger); }
  
  public EnumJvmRTBootClassPathSupport() throws IllegalArgumentException {}
  
  public EnumJvmRTBootClassPathSupport(String paramString) throws IllegalArgumentException { super(paramString); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\management\snmp\jvmmib\EnumJvmRTBootClassPathSupport.class
