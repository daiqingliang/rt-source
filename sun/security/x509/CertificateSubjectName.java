...
public class CertificateSubjectName extends Object implements CertAttrSet<String> {
  ...
  public CertificateSubjectName(X500Name paramX500Name) { this.dnName = paramX500Name; }
  
  public CertificateSubjectName(DerInputStream paramDerInputStream) throws IOException { this.dnName = new X500Name(paramDerInputStream); }
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\security\x509\CertificateSubjectName.class
