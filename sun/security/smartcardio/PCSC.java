...
final class PCSC extends PlatformPCSC {
  ...
  public static String toString(byte[] paramArrayOfByte) {
    StringBuffer stringBuffer = new StringBuffer(paramArrayOfByte.length * 3);
    for (byte b = 0; b < paramArrayOfByte.length; b++) {
      byte b1 = paramArrayOfByte[b] & 0xFF;
      if (b)
        stringBuffer.append(':'); 
      stringBuffer.append(hexDigits[b1 >>> 4]);
      stringBuffer.append(hexDigits[b1 & 0xF]);
    } 
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\sun\security\smartcardio\PCSC.class
