...
public final class SimpleAsynchronousFileChannelImplRMHooks {
  ...
  public void close() {
    ...
    try {
      ...
      JavaIOFileDescriptorAccess javaIOFileDescriptorAccess = SharedSecrets.getJavaIOFileDescriptorAccess();
      ResourceIdImpl resourceIdImpl = ResourceIdImpl.of(Integer.valueOf(javaIOFileDescriptorAccess.get(this.fdObj)));
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\jdk\management\resource\internal\inst\SimpleAsynchronousFileChannelImplRMHooks.class
