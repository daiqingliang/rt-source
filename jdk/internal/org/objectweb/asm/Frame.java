  ...
  boolean merge(ClassWriter paramClassWriter, Frame paramFrame, int paramInt) {
      ...
      if (this.outputLocals != null && i < this.outputLocals.length) {
        ...
        if (i1 == 0) {
          ...
          if (i3 == 16777216) {
            ...
            if (i3 == 33554432) {
              n = i2 + this.inputLocals[i1 & 0x7FFFFF];
            } else {
              n = i2 + this.inputStack[k - (i1 & 0x7FFFFF)];
            } 
            if ((i1 & 0x800000) != 0 && (n == 16777220 || n == 16777219))
              n = 16777216; 
          } 
        } 
      } else {
    ...
    for (i = 0; i < this.outputStackTop; i++) {
      ...
      if (i2 == 16777216) {
        ...
        if (i2 == 33554432) {
          i3 = i1 + this.inputLocals[n & 0x7FFFFF];
        } else {
          i3 = i1 + this.inputStack[k - (n & 0x7FFFFF)];
        } 
        if ((n & 0x800000) != 0 && (i3 == 16777220 || i3 == 16777219))
          i3 = 16777216; 
      } 
      if (this.initializations != null)
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\jdk\internal\org\objectweb\asm\Frame.class
