...
class MethodWriter extends MethodVisitor {
  ...
  public AnnotationVisitor visitLocalVariableAnnotation(int paramInt, TypePath paramTypePath, Label[] paramArrayOfLabel1, Label[] paramArrayOfLabel2, int[] paramArrayOfInt, String paramString, boolean paramBoolean) {
    ...
    if (paramTypePath == null) {
      ...
      b = paramTypePath.b[paramTypePath.offset] * 2 + 1;
      byteVector.putByteArray(paramTypePath.b, paramTypePath.offset, b);
    } 
    byteVector.putShort(this.cw.newUTF8(paramString)).putShort(0);
    AnnotationWriter annotationWriter = new AnnotationWriter(this.cw, true, byteVector, byteVector, byteVector.length - 2);
    if (paramBoolean) {
      ...
      for (Label label2 = this.labels; label2 != null; label2 = label2.successor) {
        ...
        if ((label2.status & 0x40) == 0) {
          ...
          if (k >= j) {
            ...
            this.code.data[k] = -65;
            m = startFrame(j, 0, 1);
            this.frame[m] = 0x1700000 | this.cw.addType("java/lang/Throwable");
            endFrame();
  ...
  private void visitFrame(Frame paramFrame) {
    ...
    int i = startFrame(paramFrame.owner.position, b3, b4);
    b1 = 0;
    while (b3 > 0) {
      int j = arrayOfInt1[b1];
      this.frame[i++] = j;
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\jdk\internal\org\objectweb\asm\MethodWriter.class
