...
public class Label {
  ...
  void visitSubroutine(Label paramLabel, long paramLong, int paramInt) {
    ...
    while (label != null) {
      ...
      for (Edge edge = label1.successors; edge != null; edge = edge.next) {
...
/* Location:              D:\software\jd-gui\jd-gui-windows-1.6.3\rt.jar!\jdk\internal\org\objectweb\asm\Label.class
